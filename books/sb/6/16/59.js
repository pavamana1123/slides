var text = {
    ...
    "verses": [
        {
            "roman": "småtvehäyäà parikleçaà\ntataù phala-viparyayam\nabhayaà cäpy anéhäyäà\nsaìkalpäd viramet kaviù\n"
        }
    ],
    "synonyms": "småtvä—remembering; éhäyäm—in the field of activities with fruitive results; parikleçam—the waste of energy and the miserable conditions; tataù—from that; phala-viparyayam—the opposite of the desired result; abhayam—fearlessness; ca—also; api—indeed; anéhäyäm—when there is no desire for fruitive results; saìkalpät—from material desire; viramet—should cease; kaviù—one who is advanced in knowledge.",
