var text = {
    "info": {
        "id": "sb/10/3/18",
        "prevId": "sb/10/3/15-17",
        "nextId": "sb/10/3/19"
    },
    "verses": [
        {
            "roman": "ya ätmano dåçya-guëeñu sann iti\nvyavasyate sva-vyatirekato 'budhaù\nvinänuvädaà na ca tan manéñitaà\nsamyag yatas tyaktam upädadat pumän\n"
        }
    ],
    "synonyms": "yaù—anyone who; ätmanaù—of his own real identity, the soul; dåçya-guëeñu—among the visible objects, beginning with the body; san—being situated in that position; iti—thus; vyavasyate—continues to act; sva-vyatirekataù—as if the body were independent of the soul; abudhaù—a rascal; vinä anuvädam—without proper analytical study; na—not; ca—also; tat—the body and other visible objects; manéñitam—such considerations having been discussed; samyak—fully; yataù—because he is a fool; tyaktam—are rejected; upädadat—accepts this body as reality; pumän—a person.",
    "translation": "One who considers his visible body, which is a product of the three modes of nature, to be independent of the soul is unaware of the basis of existence, and therefore he is a rascal. Those who are learned have rejected his conclusion because one can understand through full discussion that with no basis in soul, the visible body and senses would be insubstantial. Nonetheless, although his conclusion has been rejected, a foolish person considers it a reality.",
    "purport": [
        {
            "type": "normal",
            "content": "Without the basic principle of soul, the body cannot be produced. So-called scientists have tried in many ways to produce a living body in their chemical laboratories, but no one has been able to do it because unless the spirit soul is present, a body cannot be prepared from material elements. Since scientists are now enamored of theories about the chemical composition of the body, we have challenged many scientists to make even a small egg. The chemicals in eggs can be found very easily. There is a white substance and a yellow substance, covered by a shell, and modern scientists should very easily be able to duplicate all this. But even if they were to prepare such an egg and put it in an incubator, this man-made chemical egg would not produce a chicken. The soul must be added because there is no question of a chemical combination for life. Those who think that life can exist without the soul have therefore been described here as abudhaù, foolish rascals."
        },
        {
            "type": "normal",
            "content": "Again, there are those who reject the body, regarding it as insubstantial. They are of the same category of fools. One can neither reject the body nor accept it as substantial. The substance is the Supreme Personality of Godhead, and both the body and the soul are energies of the Supreme Godhead, as described by the Lord Himself in Bhagavad-gétä :"
        },
        {
            "type": "verse",
        ...
        {
            "type": "verse",
            "content": "apareyam itas tv anyäàprakåtià viddhi me paräm\njéva-bhütäà mahä-bähoyayedaà dhäryate jagat"
        },
        {
            "type": "normal",
