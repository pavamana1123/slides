var text = {
    ...
    "verses": [
        {
            "roman": "karmästu hetuù sukha-duùkhayoç cet\nkim ätmanas tad dhi jaòäjaòatve\ndehas tv acit puruño 'yaà suparëaù\nkrudhyeta kasmai na hi karma mülam\n"
        }
    ],
    "synonyms": "karma—one's fruitive activities; astu—hypothetically granted; hetuù—the cause; sukha-duùkhayoù—of happiness and distress; cet—if; kim—what; ätmanaù—for the soul; tat—that karma; hi—certainly; jaòa-ajaòatve—in being both material and not material; dehaù—the body; tu—on the one hand; acit—not living; puruñaù—the person; ayam—this; su-parëaù—endowed with living consciousness; krudhyeta—one should become angry; kasmai—at whom; na—are not; hi—certainly; karma—fruitive activities; mülam—the root cause.",
