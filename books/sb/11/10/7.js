var text = {
    ...
    "verses": [
        {
            "roman": "jäyäpatya-gåha-kñetra-\nsvajana-draviëädiñu\nudäsénaù samaà paçyan\nsarveñv artham ivätmanaù\n"
        }
    ],
    "synonyms": "jäyä—to wife; apatya—children; gåha—home; kñetra—land; svajana—relatives and friends; draviëa—bank account; ädiñu—and so on; udäsénaù—remaining indifferent; samam—equally; paçyan—seeing; sarveñu—in all of these; artham—purpose; iva—like; ätmanaù—of oneself.",
    "translation": "One should see one's real self-interest in life in all circumstances and should therefore remain detached from wife, children, home, land, relatives, friends, wealth and so on.",
    "purport": [
        {
            "type": "normal",
