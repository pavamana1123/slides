var text = {
    ...
    "verses": [
        {
            "roman": "yas tu yasyädir antaç ca\nsa vai madhyaà ca tasya san\nvikäro vyavahärärtho\nyathä taijasa-pärthiväù\n"
        }
    ],
    "synonyms": "yaù—which (cause); tu—and; yasya—of which (product); ädiù—the beginning; antaù—the end; ca—and; saù—that; vai—indeed; madhyam—the middle; ca—and; tasya—of that product; san—being (real); vikäraù—the transformation; vyavahära-arthaù—for ordinary purposes; yathä—as; taijasa—things produced from gold (which is itself derived from fire); pärthivaù—and things produced from earth.",
