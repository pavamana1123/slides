var text = {
    ...
    "verses": [
        {
            "roman": "viñayäbhiniveçena\nnätmänaà yat smaret punaù\njantor vai kasyacid dhetor\nmåtyur atyanta-vismåtiù\n"
        }
    ],
    "synonyms": "viñaya—in (new) objects of perception; abhiniveçena—because of absorption; na—not; ätmänam—his previous self; yat—the situation in which; smaret—remembers; punaù—any more; jantoù—of the living entity; vai—indeed; kasyacit hetoù—for any reason or other; måtyuù—known as death; atyanta—total; vismåtiù—forgetfulness.",
