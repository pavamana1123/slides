var text = {
    ...
    "verses": [
        {
            "roman": "kvacic cäçeña-doña-niñadanaà puréña-viçeñaà\ntad-varëa-guëa-nirmita-matiù suvarëam\nupäditsaty agni-käma-kätara ivolmuka-piçäcam\n"
        }
    ],
    "synonyms": "kvacit—sometimes; ca—also; açeña—unlimited; doña—of faults; niñadanam—the source of; puréña—of stool; viçeñam—a particular type; tat-varëa-guëa—whose color is the same as that of the mode of passion (reddish); nirmita-matiù—whose mind is absorbed in that; suvarëam—gold; upäditsati—desiring to get; agni-käma—by the desire for fire; kätaraù—who is troubled; iva—like; ulmuka-piçäcam—a phosphorescent light known as a will-o'-the-wisp, which is sometimes mistaken for a ghost.",
