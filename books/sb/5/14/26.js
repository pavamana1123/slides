var text = {
    ...
    "verses": [
        {
            "roman": "kvacin mitho vyavaharan yat kiïcid dhanam\nanyebhyo vä käkiëikä-mätram apy apaharan\nyat kiïcid vä vidveñam eti vitta-çäöhyät\n"
        }
    ],
    "synonyms": "kvacit—sometimes; mithaù—with one another; vyavaharan—trading; yat kiïcit—whatever little bit; dhanam—money; anyebhyaù—from others; vä—or; käkiëikä-mätram—a very small amount (twenty cowries); api—certainly; apaharan—taking away by cheating; yat kiïcit—whatever small amount; vä—or; vidveñam eti—creates enmity; vitta-çäöhyät—because of cheating.",
