var text = {
    ...
    "verses": [
        {
            "roman": "viçvam ätma-gataà vyaïjan\nküöa-stho jagad-aìkuraù\nsva-tejasäpibat tévram\nätma-prasväpanaà tamaù\n"
        }
    ],
    "synonyms": "viçvam—the universe; ätma-gatam—contained within itself; vyaïjan—manifesting; küöa-sthaù—unchangeable; jagat-aìkuraù—the root of all cosmic manifestations; sva-tejasä—by its own effulgence; apibat—swallowed; tévram—dense; ätma-prasväpanam—which had covered the mahat-tattva; tamaù—darkness.",
