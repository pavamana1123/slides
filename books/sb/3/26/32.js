var text = {
    ...
    "verses": [
        {
            "roman": "tämasäc ca vikurväëäd\nbhagavad-vérya-codität\nçabda-mätram abhüt tasmän\nnabhaù çrotraà tu çabdagam\n"
        }
    ],
    "synonyms": "tämasät—from egoism in ignorance; ca—and; vikurväëät—undergoing transformation; bhagavat-vérya—by the energy of the Supreme Personality of Godhead; codität—impelled; çabda-mätram—the subtle element sound; abhüt—was manifested; tasmät—from that; nabhaù—ether; çrotram—the sense of hearing; tu—then; çabda-gam—which catches sound.",
    "translation": "When egoism in ignorance is agitated by the sex energy of the Supreme Personality of Godhead, the subtle element sound is manifested, and from sound come the ethereal sky and the sense of hearing.",
    "purport": [
        {
            "type": "normal",
