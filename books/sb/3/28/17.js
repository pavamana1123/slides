var text = {
    ...
    "verses": [
        {
            "roman": "apécya-darçanaà çaçvat\nsarva-loka-namaskåtam\nsantaà vayasi kaiçore\nbhåtyänugraha-kätaram\n"
        }
    ],
    "synonyms": "apécya-darçanam—very beautiful to see; çaçvat—eternal; sarva-loka—by all the inhabitants of every planet; namaù-kåtam—worshipable; santam—situated; vayasi—in youth; kaiçore—in boyhood; bhåtya—upon His devotee; anugraha—to bestow blessings; kätaram—eager.",
