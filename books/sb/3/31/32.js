var text = {
    ...
    "verses": [
        {
            "roman": "yady asadbhiù pathi punaù\nçiçnodara-kåtodyamaiù\nästhito ramate jantus\ntamo viçati pürvavat\n"
        }
    ],
    "synonyms": "yadi—if; asadbhiù—with the unrighteous; pathi—on the path; punaù—again; çiçna—for the genitals; udara—for the stomach; kåta—done; udyamaiù—whose endeavors; ästhitaù—associating; ramate—enjoys; jantuù—the living entity; tamaù—darkness; viçati—enters; pürva-vat—as before.",
