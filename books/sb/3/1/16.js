var text = {
    ...
    "verses": [
        {
            "roman": "svayaà dhanur dväri nidhäya mäyäà\nbhrätuù puro marmasu täòito 'pi\nsa ittham atyulbaëa-karëa-bäëair\ngata-vyatho 'yäd uru mänayänaù\n"
        }
    ],
    "synonyms": "saù—he (Vidura); ittham—like this; ati-ulbaëa—severely; karëa—ear; bäëaiù—by the arrows; bhrätuù—brother's; puraù—from the palace; marmasu—in the core of the heart; täòitaù—being afflicted; api—in spite of; svayam—he himself; dhanuù dväri—bow on the door; nidhäya—keeping; mäyäm—the external nature; gata-vyathaù—without being sorry; ayät—exited; uru—great; mäna-yänaù—so thinking.",
    ...
    "purport": [
        {
            "type": "normal",
            "content": "A pure devotee of the Lord is never perturbed by an awkward position created by the external energy of the Lord. In Bhagavad-gétä  it is stated:"
        },
        {
            "type": "verse",
