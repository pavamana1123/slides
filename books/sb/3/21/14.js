var text = {
    ...
    "verses": [
        {
            "roman": "ye mäyayä te hata-medhasas tvat-\npädäravindaà bhava-sindhu-potam\nupäsate käma-laväya teñäà\nräséça kämän niraye 'pi ye syuù\n"
        }
    ],
    "synonyms": "ye—those persons; mäyayä—by the deluding energy; te—of You; hata—has been lost; medhasaù—whose intelligence; tvat—Your; päda-aravindam—lotus feet; bhava—of mundane existence; sindhu—the ocean; potam—the boat for crossing; upäsate—worship; käma-laväya—for obtaining trivial pleasures; teñäm—their; räsi—You bestow; éça—O Lord; kämän—desires; niraye—in hell; api—even; ye—which desires; syuù—can be available.",
