var text = {
    ...
    "verses": [
        {
            "roman": "abhyasen manasä çuddhaà\ntrivåd-brahmäkñaraà param\nmano yacchej jita-çväso\nbrahma-béjam avismaran\n"
        }
    ],
    "synonyms": "abhyaset—one should practice; manasä—by the mind; çuddham—sacred; tri-våt—composed of the three; brahma-akñaram—transcendental letters; param—the supreme; manaù—mind; yacchet—get under control; jita-çväsaù—by regulating the breathing air; brahma—absolute; béjam—seed; avismaran—without being forgotten.",
