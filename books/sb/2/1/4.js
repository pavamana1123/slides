var text = {
    ...
    "verses": [
        {
            "roman": "dehäpatya-kalaträdiñu\nätma-sainyeñv asatsv api\nteñäà pramatto nidhanaà\npaçyann api na paçyati\n"
        }
    ],
    "synonyms": "deha—body; apatya—children; kalatra—wife; ädiñu—and in everything in relation to them; ätma—own; sainyeñu—fighting soldiers; asatsu—fallible; api—in spite of; teñäm—of all of them; pramattaù—too attached; nidhanam—destruction; paçyan—having been experienced; api—although; na—does not; paçyati—see it.",
    "translation": "Persons devoid of ätma-tattva do not inquire into the problems of life, being too attached to the fallible soldiers like the body, children and wife. Although sufficiently experienced, they still do not see their inevitable destruction.",
    "purport": [
        {
            "type": "normal",
        ...
        {
            "type": "normal",
            "content": "Our friends, relatives and so-called wives and children are not only fallible, but also bewildered by the outward glamor of material existence. As such, they cannot save us. Still we think that we are safe within the orbit of family, society or country."
        },
        {
            "type": "normal",
            "content": "The whole materialistic advancement of human civilization is like the decoration of a dead body. Everyone is a dead body flapping only for a few days, and yet all the energy of human life is being wasted in the decoration of this dead body. Çukadeva Gosvämé is pointing out the duty of the human being after showing the actual position of bewildered human activities. Persons who are devoid of the knowledge of ätma-tattva are misguided, but those who are devotees of the Lord and have perfect realization of transcendental knowledge are not bewildered."
        }
    ]
}
