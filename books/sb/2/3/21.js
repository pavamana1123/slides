var text = {
    ...
    "verses": [
        {
            "roman": "bhäraù paraà paööa-kiréöa-juñöam\napy uttamäìgaà na namen mukundam\nçävau karau no kurute saparyäà\nharer lasat-käïcana-kaìkaëau vä\n"
        }
    ],
    "synonyms": "bhäraù—a great burden; param—heavy; paööa—silk; kiréöa—turban; juñöam—dressed with; api—even; uttama—upper; aìgam—parts of the body; na—never; namet—bow down; mukundam—Lord Kåñëa, the deliverer; çävau—dead bodies; karau—hands; no—do not; kurute—do; saparyäm—worshiping; hareù—of the Personality of Godhead; lasat—glittering; käïcana—made of gold; kaìkaëau—bangles; vä—even though.",
