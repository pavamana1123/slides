var text = {
    ...
    "verses": [
        {
            "roman": "sadhryaì niyamya yatayo yama-karta-hetià\njahyuù svaräò iva nipäna-khanitram indraù\n"
        }
    ],
    "synonyms": "sadhryak—artificial mental speculation or meditation; niyamya—controlling; yatayaù—the mystics; yama-karta-hetim—the process of spiritual culture; jahyuù—are given up; svaräö—fully independent; iva—as; nipäna—well; khanitram—trouble for digging; indraù—the controlling demigod supplying rains.",
    "translation": "In such a transcendental state there is no need of artificial control of the mind, mental speculation or meditation, as performed by the jïänés and yogés. One gives up such processes, as the heavenly King, Indra, forgoes the trouble to dig a well.",
    "purport": [
        {
            "type": "normal",
