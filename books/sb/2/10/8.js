var text = {
    ...
    "verses": [
        {
            "roman": "yo 'dhyätmiko 'yaà puruñaù\nso 'säv evädhidaivikaù\nyas tatrobhaya-vicchedaù\npuruño hy ädhibhautikaù\n"
        }
    ],
    "synonyms": "yaù—one who; adhyätmikaù—is possessed of the sense organs; ayam—this; puruñaù—personality; saù—he; asau—that; eva—also; adhidaivikaù—controlling deity; yaù—that which; tatra—there; ubhaya—of both; vicchedaù—separation; puruñaù—person; hi—for; ädhibhautikaù—the visible body or the embodied living entity.",
    "translation": "The individual person possessing different instruments of senses is called the adhyätmic person, and the individual controlling deity of the senses is called adhidaivic. The embodiment seen on the eyeballs is called the adhibhautic person.",
    "purport": [
        {
            "type": "normal",
            "content": "The supreme controlling summum bonum is the Personality of Godhead in His plenary portion of Paramätmä, or the Supersoul manifestation. In the Bhagavad-gétä  it is said:"
        },
        {
            "type": "verse",
