var text = {
    ...
    "verses": [
        {
            "roman": "vadanti tat tattva-vidas\ntattvaà yaj jïänam advayam\nbrahmeti paramätmeti\nbhagavän iti çabdyate\n"
        }
    ],
    "synonyms": "vadanti—they say; tat—that; tattva-vidaù—the learned souls; tattvam—the Absolute Truth; yat—which; jïänam—knowledge; advayam—nondual; brahma iti—known as Brahman; paramätmä iti—known as Paramätmä; bhagavän iti—known as Bhagavän; çabdyate—it so sounded.",
    "translation": "Learned transcendentalists who know the Absolute Truth call this nondual substance Brahman, Paramätmä or Bhagavän.",
    "purport": [
        {
            "type": "normal",
