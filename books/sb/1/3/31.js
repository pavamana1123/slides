var text = {
    ...
    "verses": [
        {
            "roman": "yathä nabhasi meghaugho\nreëur vä pärthivo 'nile\nevaà drañöari dåçyatvam\näropitam abuddhibhiù\n"
        }
    ],
    "synonyms": "yathä—as it is; nabhasi—in the sky; megha-oghaù—a mass of clouds; reëuù—dust; vä—as well as; pärthivaù—muddiness; anile—in the air; evam—thus; drañöari—to the seer; dåçyatvam—for the purpose of seeing; äropitam—is implied; abuddhibhiù—by the less intelligent persons.",
