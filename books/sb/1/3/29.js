var text = {
    ...
    "verses": [
        {
            "roman": "janma guhyaà bhagavato\nya etat prayato naraù\nsäyaà prätar gåëan bhaktyä\nduùkha-grämäd vimucyate\n"
        }
    ],
    "synonyms": "janma—birth; guhyam—mysterious; bhagavataù—of the Lord; yaù—one; etat—all these; prayataù—carefully; naraù—man; säyam—evening; prätaù—morning; gåëan—recites; bhaktyä—with devotion; duùkha-grämät—from all miseries; vimucyate—gets relief from.",
