var text = {
    ...
    "verses": [
        {
            "roman": "yady eñoparatä devé\nmäyä vaiçäradé matiù\nsampanna eveti vidur\nmahimni sve mahéyate\n"
        }
    ],
    "synonyms": "yadi—if, however; eñä—they; uparatä—subsided; devé mäyä—illusory energy; vaiçäradé—full of knowledge; matiù—enlightenment; sampannaù—enriched with; eva—certainly; iti—thus; viduù—being cognizant of; mahimni—in the glories; sve—of the self; mahéyate—being situated in.",
