var text = {
    ...
    "verses": [
        {
            "roman": "tritve hutvä ca païcatvaà\ntac caikatve 'juhon muniù\nsarvam ätmany ajuhavéd\nbrahmaëy ätmänam avyaye\n"
        }
    ],
    "synonyms": "tritve—into the three qualities; hutvä—having offered; ca—also; païcatvam—five elements; tat—that; ca—also; ekatve—in one nescience; ajuhot—amalgamated; muniù—the thoughtful; sarvam—the sum total; ätmani—in the soul; ajuhavét—fixed; brahmaëi—unto the spirit; ätmänam—the soul; avyaye—unto the inexhaustible.",
