var text = {
    ...
    "verses": [
        {
            "roman": "rüpaà bhagavato yat tan\nmanaù-käntaà çucäpaham\napaçyan sahasottasthe\nvaiklavyäd durmanä iva\n"
        }
    ],
    "synonyms": "rüpam—form; bhagavataù—of the Personality of Godhead; yat—as it is; tat—that; manaù—of the mind; käntam—as it desires; çuca-apaham—vanishing all disparity; apaçyan—without seeing; sahasä—all of a sudden; uttasthe—got up; vaiklavyät—being perturbed; durmanäù—having lost the desirable; iva—as it were.",
