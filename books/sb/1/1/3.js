var text = {
    ...
    "purport": [
        ...
        {
            "type": "normal",
            "content": "Every living entity, beginning from Brahmä, the first-born living being within the material world, down to the insignificant ant, desires to relish some sort of taste derived from sense perceptions. These sensual pleasures are technically called rasas. Such rasas are of different varieties. In the revealed scriptures the following twelve varieties of rasas are enumerated: (1) raudra (anger), (2) adbhuta (wonder), (3) çåìgära (conjugal love), (4) häsya (comedy), (5) véra (chivalry), (6) dayä (mercy), (7) däsya (servitorship), (8) sakhya (fraternity), (9) bhayänaka (horror), (10) bébhatsa (shock), (11) çänta (neutrality), (12) vätsalya (parenthood)."
        },
        {
            "type": "normal",
        ...
        {
            "type": "normal",
            "content": "The Supreme Personality of Godhead is therefore described in the çruti-mantras, Vedic hymns, as \"the fountainhead of all rasas.\" When one associates with the Supreme Lord and exchanges one's constitutional rasa with the Lord, then the living being is actually happy."
        },
        {
            "type": "normal",
            "content": "These çruti-mantras indicate that every living being has its constitutional position, which is endowed with a particular type of rasa to be exchanged with the Personality of Godhead. In the liberated condition only, this primary rasa is experienced in full. In the material existence, the rasa is experienced in the perverted form, which is temporary. And thus the rasas of the material world are exhibited in the material form of raudra (anger) and so on."
        },
        {
            "type": "normal",
