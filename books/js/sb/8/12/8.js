var text = {
    ...
    "verses": [
        {
            "roman": "ekas tvam eva sad asad dvayam advayaṁ ca\nsvarṇaṁ kṛtākṛtam iveha na vastu-bhedaḥ\najñānatas tvayi janair vihito vikalpo\nyasmād guṇa-vyatikaro nirupādhikasya\n"
        }
    ],
    "synonyms": "ekaḥ—the only one; tvam—Your Lordship; eva—indeed; sat—which is existing, as the effect; asat—which is nonexistent, as the cause; dvayam—both of them; advayam—without duality; ca—and; svarṇam—gold; kṛta—manufactured into different forms; ākṛtam—the original source of gold (the gold mine); iva—like; iha—in this world; na—not; vastu-bhedaḥ—difference in the substance; ajñānataḥ—only because of ignorance; tvayi—unto You; janaiḥ—by the general mass of people; vihitaḥ—it should be done; vikalpaḥ—differentiation; yasmāt—because of; guṇa-vyatikaraḥ—free from the differences created by the material modes of nature; nirupādhikasya—without any material designation.",
    ...
    "purport": [
        {
            "type": "normal",
            "content": "Śrīla Viśvanātha Cakravartī Ṭhākura says that the living entities are representations of the Supreme Personality of Godhead's marginal potency whereas the various bodies accepted by the living entities are products of the material energy. Thus the body is considered material, and the soul is considered spiritual. The origin of them both, however, is the same Supreme Personality of Godhead. As the Lord explains in Bhagavad-gītā :"
        },
        {
            "type": "verse",
            "content": "bhūmir āpo 'nalo vāyuḥkhaṁ mano buddhir eva ca\nahaṅkāra itīyaṁ mebhinnā prakṛtir aṣṭadhā"
        },
        {
            "type": "verse",
            "content": "apareyam itas tv anyāṁprakṛtiṁ viddhi me parām\njīva-bhūtāṁ mahā-bāhoyayedaṁ dhāryate jagat"
        },
        {
            "type": "normal",
