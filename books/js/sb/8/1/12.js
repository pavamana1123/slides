var text = {
    ...
    "verses": [
        {
            "roman": "na yasyādy-antau madhyaṁ ca\nsvaḥ paro nāntaraṁ bahiḥ\nviśvasyāmūni yad yasmād\nviśvaṁ ca tad ṛtaṁ mahat\n"
        }
    ],
    "synonyms": "na—neither; yasya—of whom (the Supreme Personality of Godhead); ādi—a beginning; antau—end; madhyam—middle; ca—also; svaḥ—own; paraḥ—others; na—nor; antaram—inside; bahiḥ—outside; viśvasya—of the whole cosmic manifestation; amūni—all such considerations; yat—whose form; yasmāt—from He who is the cause of everything; viśvam—the whole universe; ca—and; tat—all of them; ṛtam—truth; mahat—very, very great.",
    ...
    "purport": [
        {
            "type": "normal",
            "content": "The Supreme Personality of Godhead, Kṛṣṇa, is described in the Brahma-saṁhitā (BS 5.38):"
        },
        {
            "type": "verse",
