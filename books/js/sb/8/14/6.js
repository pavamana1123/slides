var text = {
    ...
    "verses": [
        {
            "roman": "pālayanti prajā-pālā\nyāvad antaṁ vibhāgaśaḥ\nyajña-bhāga-bhujo devā\nye ca tatrānvitāś ca taiḥ\n"
        }
    ],
    "synonyms": "pālayanti—execute the order; prajā-pālāḥ—the rulers of the world, namely the sons and grandsons of Manu; yāvat antam—unto the end of Manu's reign; vibhāgaśaḥ—in divisions; yajña-bhāga-bhujaḥ—the enjoyers of the result of yajñas; devāḥ—the demigods; ye—others; ca—also; tatra anvitāḥ—engaged in that business; ca—also; taiḥ—by them.",
    "translation": "To enjoy the results of sacrifices [yajñas], the rulers of the world, namely the sons and grandsons of Manu, discharge the orders of the Supreme Personality of Godhead until the end of Manu's reign. The demigods also share the results of these sacrifices.",
    "purport": [
        {
            "type": "normal",
