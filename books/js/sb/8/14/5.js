var text = {
    ...
    "verses": [
        {
            "roman": "tato dharmaṁ catuṣpādaṁ\nmanavo hariṇoditāḥ\nyuktāḥ sañcārayanty addhā\nsve sve kāle mahīṁ nṛpa\n"
        }
    ],
    "synonyms": "tataḥ—thereafter (at the end of Kali-yuga); dharmam—the religious principle; catuḥ-pādam—in four parts; manavaḥ—all the Manus; hariṇā—by the Supreme Personality of Godhead; uditāḥ—being instructed; yuktāḥ—being engaged; sañcārayanti—reestablish; addhā—directly; sve sve—in their own; kāle—time; mahīm—within this world; nṛpa—O King.",
    "translation": "Thereafter, O King, the Manus, being fully engaged according to the instructions of the Supreme Personality of Godhead, directly reestablish the principles of occupational duty in its full four parts.",
    "purport": [
        {
            "type": "normal",
            "content": "Dharma, or occupational duty, can be established in its full four parts as explained in Bhagavad-gītā. In Bhagavad-gītā  the Lord says:"
        },
        {
            "type": "verse",
