var text = {
    ...
    "verses": [
        {
            "roman": "janma-karma-vayo-rūpa-\nvidyaiśvarya-dhanādibhiḥ\nyady asya na bhavet stambhas\ntatrāyaṁ mad-anugrahaḥ\n"
        }
    ],
    "synonyms": "janma—by birth in an aristocratic family; karma—by wonderful activities, pious activities; vayaḥ—by age, especially youth, when one is capable of doing many things; rūpa—by personal beauty, which attracts everyone; vidyā—by education; aiśvarya—by opulence; dhana—by wealth; ādibhiḥ—by other opulences also; yadi—if; asya—of the possessor; na—not; bhavet—there is; stambhaḥ—pride; tatra—in such a condition; ayam—a person; mat-anugrahaḥ—should be considered to have received My special mercy.",
