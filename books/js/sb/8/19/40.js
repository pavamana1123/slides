var text = {
    ...
    "verses": [
        {
            "roman": "tad yathā vṛkṣa unmūlaḥ\nśuṣyaty udvartate 'cirāt\nevaṁ naṣṭānṛtaḥ sadya\nātmā śuṣyen na saṁśayaḥ\n"
        }
    ],
    "synonyms": "tat—therefore; yathā—as; vṛkṣaḥ—a tree; unmūlaḥ—being uprooted; śuṣyati—dries up; udvartate—falls down; acirāt—very soon; evam—in this way; naṣṭa—lost; anṛtaḥ—the temporary body; sadyaḥ—immediately; ātmā—the body; śuṣyet—dries up; na—not; saṁśayaḥ—any doubt.",
    "translation": "When a tree is uprooted it immediately falls down and begins to dry up. Similarly, if one doesn't take care of the body, which is supposed to be untruth—in other words, if the untruth is uprooted—the body undoubtedly becomes dry.",
    "purport": [
        {
            "type": "normal",
            "content": "In this regard, Śrīla Rūpa Gosvāmī says:"
        },
        {
            "type": "verse",
