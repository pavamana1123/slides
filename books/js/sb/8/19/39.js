var text = {
    ...
    "verses": [
        {
            "roman": "satyaṁ puṣpa-phalaṁ vidyād\nātma-vṛkṣasya gīyate\nvṛkṣe 'jīvati tan na syād\nanṛtaṁ mūlam ātmanaḥ\n"
        }
    ],
    "synonyms": "satyam—the factual truth; puṣpa-phalam—the flower and the fruit; vidyāt—one should understand; ātma-vṛkṣasya—of the tree of the body; gīyate—as described in the Vedas; vṛkṣe ajīvati—if the tree is not living; tat—that (puṣpa-phalam); na—not; syāt—is possible; anṛtam—untruth; mūlam—the root; ātmanaḥ—of the body.",
