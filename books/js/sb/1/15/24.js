var text = {
    ...
    "verses": [
        {
            "roman": "prāyeṇaitad bhagavata\nīśvarasya viceṣṭitam\nmitho nighnanti bhūtāni\nbhāvayanti ca yan mithaḥ\n"
        }
    ],
    "synonyms": "prāyeṇa etat—it is almost by; bhagavataḥ—of the Personality of Godhead; īśvarasya—of the Lord; viceṣṭitam—by the will of; mithaḥ—one another; nighnanti—do kill; bhūtāni—the living beings; bhāvayanti—as also protect; ca—also; yat—of whom; mithaḥ—one another.",
