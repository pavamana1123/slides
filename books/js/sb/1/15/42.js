var text = {
    ...
    "verses": [
        {
            "roman": "tritve hutvā ca pañcatvaṁ\ntac caikatve 'juhon muniḥ\nsarvam ātmany ajuhavīd\nbrahmaṇy ātmānam avyaye\n"
        }
    ],
    "synonyms": "tritve—into the three qualities; hutvā—having offered; ca—also; pañcatvam—five elements; tat—that; ca—also; ekatve—in one nescience; ajuhot—amalgamated; muniḥ—the thoughtful; sarvam—the sum total; ātmani—in the soul; ajuhavīt—fixed; brahmaṇi—unto the spirit; ātmānam—the soul; avyaye—unto the inexhaustible.",
