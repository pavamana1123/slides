var text = {
    ...
    "verses": [
        {
            "roman": "yayāharad bhuvo bhāraṁ\ntāṁ tanuṁ vijahāv ajaḥ\nkaṇṭakaṁ kaṇṭakeneva\ndvayaṁ cāpīśituḥ samam\n"
        }
    ],
    "synonyms": "yayā—that by which; aharat—took away; bhuvaḥ—of the world; bhāram—burden; tām—that; tanum—body; vijahau—relinquished; ajaḥ—the unborn; kaṇṭakam—thorn; kaṇṭakena—by the thorn; iva—like that; dvayam—both; ca—also; api—although; īśituḥ—controlling; samam—equal.",
