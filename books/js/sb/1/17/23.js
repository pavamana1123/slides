var text = {
    ...
    "verses": [
        {
            "roman": "athavā deva-māyāyā\nnūnaṁ gatir agocarā\ncetaso vacasaś cāpi\nbhūtānām iti niścayaḥ\n"
        }
    ],
    "synonyms": "athavā—alternatively; deva—the Lord; māyāyāḥ—energies; nūnam—very little; gatiḥ—movement; agocarā—inconceivable; cetasaḥ—either by the mind; vacasaḥ—by words; ca—or; api—also; bhūtānām—of all living beings; iti—thus; niścayaḥ—concluded.",
    "translation": "Thus it is concluded that the Lord's energies are inconceivable. No one can estimate them by mental speculation or by word jugglery.",
    "purport": [
        {
            "type": "normal",
