var text = {
    ...
    "verses": [
        {
            "roman": "āpannaḥ saṁsṛtiṁ ghorāṁ\nyan-nāma vivaśo gṛṇan\ntataḥ sadyo vimucyeta\nyad bibheti svayaṁ bhayam\n"
        }
    ],
    "synonyms": "āpannaḥ—being entangled; saṁsṛtim—in the hurdle of birth and death; ghorām—too complicated; yat—what; nāma—the absolute name; vivaśaḥ—unconsciously; gṛṇan—chanting; tataḥ—from that; sadyaḥ—at once; vimucyeta—gets freedom; yat—that which; bibheti—fears; svayam—personally; bhayam—fear itself.",
    "translation": "Living beings who are entangled in the complicated meshes of birth and death can be freed immediately by even unconsciously chanting the holy name of Kṛṣṇa, which is feared by fear personified.",
    "purport": [
        {
            "type": "normal",
