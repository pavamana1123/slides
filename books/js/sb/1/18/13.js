var text = {
    ...
    "verses": [
        {
            "roman": "tulayāma lavenāpi\nna svargaṁ nāpunar-bhavam\nbhagavat-saṅgi-saṅgasya\nmartyānāṁ kim utāśiṣaḥ\n"
        }
    ],
    "synonyms": "tulayāma—to be balanced with; lavena—by a moment; api—even; na—never; svargam—heavenly planets; na—nor; apunaḥ-bhavam—liberation from matter; bhagavat-saṅgi—devotee of the Lord; saṅgasya—of the association; martyānām—those who are meant for death; kim—what is there; uta—to speak of; āśiṣaḥ—worldly benediction.",
