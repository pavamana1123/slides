var text = {
    ...
    "verses": [
        {
            "roman": "tāvat kalir na prabhavet\npraviṣṭo 'pīha sarvataḥ\nyāvad īśo mahān urvyām\nābhimanyava eka-rāṭ\n"
        }
    ],
    "synonyms": "tāvat—so long; kaliḥ—the personality of Kali; na—cannot; prabhavet—flourish; praviṣṭaḥ—entered in; api—even though; iha—here; sarvataḥ—everywhere; yāvat—as long as; īśaḥ—the lord; mahān—great; urvyām—powerful; ābhimanyavaḥ—the son of Abhimanyu; eka-rāṭ—the one emperor.",
    "translation": "As long as the great, powerful son of Abhimanyu remains the Emperor of the world, there is no chance that the personality of Kali will flourish.",
    "purport": [
        {
            "type": "normal",
