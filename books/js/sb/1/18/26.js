var text = {
    ...
    "verses": [
        {
            "roman": "pratiruddhendriya-prāṇa-\nmano-buddhim upāratam\nsthāna-trayāt paraṁ prāptaṁ\nbrahma-bhūtam avikriyam\n"
        }
    ],
    "synonyms": "pratiruddha—restrained; indriya—the sense organs; prāṇa—air of respiration; manaḥ—the mind; buddhim—intelligence; upāratam—inactive; sthāna—places; trayāt—from the three; param—transcendental; prāptam—achieved; brahma-bhūtam—qualitatively equal with the Supreme Absolute; avikriyam—unaffected.",
