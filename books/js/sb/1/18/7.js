var text = {
    ...
    "verses": [
        {
            "roman": "nānudveṣṭi kaliṁ samrāṭ\nsāraṅga iva sāra-bhuk\nkuśalāny āśu siddhyanti\nnetarāṇi kṛtāni yat\n"
        }
    ],
    "synonyms": "na—never; anudveṣṭi—envious; kalim—unto the personality of Kali; samrāṭ—the Emperor; sāram-ga—realist, like the bees; iva—like; sāra-bhuk—one who accepts the substance; kuśalāni—auspicious objects; āśu—immediately; siddhyanti—become successful; na—never; itarāṇi—which are inauspicious; kṛtāni—being performed; yat—as much as.",
    "translation": "Mahārāja Parīkṣit was a realist, like the bees who only accept the essence [of a flower]. He knew perfectly well that in this age of Kali, auspicious things produce good effects immediately, whereas inauspicious acts must be actually performed [to render effects]. So he was never envious of the personality of Kali.",
    "purport": [
        {
            "type": "normal",
