var text = {
    ...
    "verses": [
        {
            "roman": "tat sarvaṁ naḥ samācakṣva\npṛṣṭo yad iha kiñcana\nmanye tvāṁ viṣaye vācāṁ\nsnātam anyatra chāndasāt\n"
        }
    ],
    "synonyms": "tat—that; sarvam—all; naḥ—unto us; samācakṣva—clearly explain; pṛṣṭaḥ—questioned; yat iha—herein; kiñcana—all that; manye—we think; tvām—you; viṣaye—in all subjects; vācām—meanings of words; snātam—fully acquainted; anyatra—except; chāndasāt—portion of the Vedas.",
    "translation": "We know that you are expert in the meaning of all subjects, except some portions of the Vedas, and thus you can clearly explain the answers to all the questions we have just put to you.",
    "purport": [
        {
            "type": "normal",
            "content": "The difference between the Vedas and the Purāṇas is like that between the brāhmaṇas and the parivrājakas. The brāhmaṇas are meant to administer some fruitive sacrifices mentioned in the Vedas, but the parivrājakācāryas, or learned preachers, are meant to disseminate transcendental knowledge to one and all. As such, the parivrājakācāryas are not always expert in pronouncing the Vedic mantras, which are practiced systematically by accent and meter by the brāhmaṇas who are meant for administering Vedic rites. Yet it should not be considered that the brāhmaṇas are more important than the itinerant preachers. They are one and different simultaneously because they are meant for the same end, in different ways."
        },
        {
            "type": "normal",
