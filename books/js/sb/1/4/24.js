var text = {
    ...
    "verses": [
        {
            "roman": "ta eva vedā durmedhair\ndhāryante puruṣair yathā\nevaṁ cakāra bhagavān\nvyāsaḥ kṛpaṇa-vatsalaḥ\n"
        }
    ],
    "synonyms": "te—that; eva—certainly; vedāḥ—the book of knowledge; durmedhaiḥ—by the less intellectual; dhāryante—can assimilate; puruṣaiḥ—by the man; yathā—as much as; evam—thus; cakāra—edited; bhagavān—the powerful; vyāsaḥ—the great sage Vyāsa; kṛpaṇa-vatsalaḥ—very kind to the ignorant mass.",
    "translation": "Thus the great sage Vyāsadeva, who is very kind to the ignorant masses, edited the Vedas so they might be assimilated by less intellectual men.",
    "purport": [
        {
            "type": "normal",
