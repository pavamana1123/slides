var text = {
    ...
    "verses": [
        {
            "roman": "dharmaḥ padaikena caran\nvicchāyām upalabhya gām\npṛcchati smāśru-vadanāṁ\nvivatsām iva mātaram\n"
        }
    ],
    "synonyms": "dharmaḥ—the personality of religious principles; padā—leg; ekena—on one only; caran—wandering; vicchāyām—overtaken by the shadow of grief; upalabhya—having met; gām—the cow; pṛcchati—asking; sma—with; aśru-vadanām—with tears on the face; vivatsām—one who has lost her offspring; iva—like; mātaram—the mother.",
