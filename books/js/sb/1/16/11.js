var text = {
    ...
    "purport": [
        {
            "type": "normal",
            "content": "Mahārāja Parīkṣit is distinguished from his grandfather Arjuna, for black horses pulled his chariot instead of white horses. He marked his flag with the mark of a lion, and his grandfather marked his with the mark of Hanumānjī. A royal procession like that of Mahārāja Parīkṣit surrounded by well-decorated chariots, cavalry, elephants, infantry and band not only is pleasing to the eyes, but also is a sign of a civilization that is aesthetic even on the fighting front."
        }
    ]
}
