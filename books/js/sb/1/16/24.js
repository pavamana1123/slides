var text = {
    ...
    "purport": [
        {
            "type": "normal",
            "content": "By the grace of the Lord, each and every planet is created fully equipped. So not only is this earth fully equipped with all the riches for the maintenance of its inhabitants, but also when the Lord descends on the earth the whole earth becomes so enriched with all kinds of opulences that even the denizens of heaven worship it with all affection. But by the will of the Lord, the whole earth can at once be changed. He can do and undo a thing by His sweet will. Therefore no one should consider himself to be self-sufficient or independent of the Lord."
        }
    ]
}
