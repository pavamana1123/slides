var text = {
    ...
    "verses": [
        {
            "roman": "avatāre ṣoḍaśame\npaśyan brahma-druho nṛpān\ntriḥ-sapta-kṛtvaḥ kupito\nniḥ-kṣatrām akaron mahīm\n"
        }
    ],
    "synonyms": "avatāre—in the incarnation of the Lord; ṣoḍaśame—the sixteenth; paśyan—seeing; brahma-druhaḥ—disobedient to the orders of the brāhmaṇas; nṛpān—the kingly order; triḥ-sapta—thrice seven times; kṛtvaḥ—had done; kupitaḥ—being engaged; niḥ—negation; kṣatrām—the administrative class; akarot—did perform; mahīm—the earth.",
    "translation": "In the sixteenth incarnation of the Godhead, the Lord [as Bhṛgupati] annihilated the administrative class [kṣatriyas] twenty-one times, being angry with them because of their rebellion against the brāhmaṇas [the intelligent class].",
    "purport": [
        {
            "type": "normal",
