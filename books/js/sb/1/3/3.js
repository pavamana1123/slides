var text = {
    ...
    "verses": [
        {
            "roman": "yasyāvayava-saṁsthānaiḥ\nkalpito loka-vistaraḥ\ntad vai bhagavato rūpaṁ\nviśuddhaṁ sattvam ūrjitam\n"
        }
    ],
    "synonyms": "yasya—whose; avayava—bodily expansion; saṁsthānaiḥ—situated in; kalpitaḥ—is imagined; loka—planets of inhabitants; vistaraḥ—various; tat vai—but that is; bhagavataḥ—of the Personality of Godhead; rūpam—form; viśuddham—purely; sattvam—existence; ūrjitam—excellence.",
