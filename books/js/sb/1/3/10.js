var text = {
    ...
    "verses": [
        {
            "roman": "pañcamaḥ kapilo nāma\nsiddheśaḥ kāla-viplutam\nprovācāsuraye sāṅkhyaṁ\ntattva-grāma-vinirṇayam\n"
        }
    ],
    "synonyms": "pañcamaḥ—the fifth one; kapilaḥ—Kapila; nāma—of the name; siddheśaḥ—the foremost amongst the perfect; kāla—time; viplutam—lost; provāca—said; āsuraye—unto the brāhmaṇa named Āsuri; sāṅkhyam—metaphysics; tattva-grāma—the sum total of the creative elements; vinirṇayam—exposition.",
