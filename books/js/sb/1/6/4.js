var text = {
    ...
    "verses": [
        {
            "roman": "prāk-kalpa-viṣayām etāṁ\nsmṛtiṁ te muni-sattama\nna hy eṣa vyavadhāt kāla\neṣa sarva-nirākṛtiḥ\n"
        }
    ],
    "synonyms": "prāk—prior; kalpa—the duration of Brahmā's day; viṣayām—subject matter; etām—all these; smṛtim—remembrance; te—your; muni-sattama—O great sage; na—not; hi—certainly; eṣaḥ—all these; vyavadhāt—made any difference; kālaḥ—course of time; eṣaḥ—all these; sarva—all; nirākṛtiḥ—annihilation.",
    "translation": "O great sage, time annihilates everything in due course, so how is it that this subject matter, which happened prior to this day of Brahmā, is still fresh in your memory, undisturbed by time?",
    "purport": [
        {
            "type": "normal",
