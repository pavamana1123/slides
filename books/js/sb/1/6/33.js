var text = {
    ...
    "verses": [
        {
            "roman": "pragāyataḥ sva-vīryāṇi\ntīrtha-pādaḥ priya-śravāḥ\nāhūta iva me śīghraṁ\ndarśanaṁ yāti cetasi\n"
        }
    ],
    "synonyms": "pragāyataḥ—thus singing; sva-vīryāṇi—own activities; tīrtha-pādaḥ—the Lord, whose lotus feet are the source of all virtues or holiness; priya-śravāḥ—pleasing to hear; āhūtaḥ—called for; iva—just like; me—to me; śīghram—very soon; darśanam—sight; yāti—appears; cetasi—on the seat of the heart.",
    "translation": "The Supreme Lord Śrī Kṛṣṇa, whose glories and activities are pleasing to hear, at once appears on the seat of my heart, as if called for, as soon as I begin to chant His holy activities.",
    "purport": [
        {
            "type": "normal",
