var text = {
    ...
    "purport": [
        ...
        {
            "type": "normal",
            "content": "Satyabhāmā instigated her husband to get the pārijāta flower from the heavenly planets, and the Lord got it even by force from the demigods, as a common husband secures things to please his wife. As already explained, the Lord had very little to do with so many wives to carry out their orders like an ordinary man. But because the queens accepted the high quality of devotional service, namely administering the Lord all comforts, the Lord played the part of a faithful and complete husband. No earthly creature can expect to have things from the heavenly kingdom, especially the pārijāta flowers, which are simply to be used by the demigods. But due to their becoming the Lord's faithful wives, all of them enjoyed the special prerogatives of the great wives of the denizens of heaven. In other words, since the Lord is the proprietor of everything within His creation, it is not very astonishing for the queens of Dvārakā to have any rare thing from any part of the universe."
        }
    ]
}
