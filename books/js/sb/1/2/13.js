var text = {
    ...
    "verses": [
        {
            "roman": "ataḥ pumbhir dvija-śreṣṭhā\nvarṇāśrama-vibhāgaśaḥ\nsvanuṣṭhitasya dharmasya\nsaṁsiddhir hari-toṣaṇam\n"
        }
    ],
    "synonyms": "ataḥ—so; pumbhiḥ—by the human being; dvija-śreṣṭhāḥ—O best among the twice-born; varṇa-āśrama—the institution of four castes and four orders of life; vibhāgaśaḥ—by the division of; svanuṣṭhitasya—of one's own prescribed duties; dharmasya—occupational; saṁsiddhiḥ—the highest perfection; hari—the Personality of Godhead; toṣaṇam—pleasing.",
    ...
    "purport": [
        ...
        {
            "type": "normal",
            "content": "Herein the statement of Bhāgavatam is that the highest aim of life or the highest perfection of the institution of the varṇāśrama-dharma is to cooperate jointly for the satisfaction of the Supreme Lord. This is also confirmed in the Bhagavad-gītā ."
        }
    ]
}
