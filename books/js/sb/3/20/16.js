var text = {
    ...
    "verses": [
        {
            "roman": "tasya nābher abhūt padmaṁ\nsahasrārkoru-dīdhiti\nsarva-jīvanikāyauko\nyatra svayam abhūt svarāṭ\n"
        }
    ],
    "synonyms": "tasya—of the Lord; nābheḥ—from the navel; abhūt—sprouted up; padmam—a lotus; sahasra-arka—a thousand suns; uru—more; dīdhiti—with dazzling splendor; sarva—all; jīva-nikāya—resting place of conditioned souls; okaḥ—place; yatra—where; svayam—himself; abhūt—emanated; sva-rāṭ—the omnipotent (Lord Brahmā).",
    "translation": "From the navel of the Personality of Godhead Garbhodakaśāyī Viṣṇu sprouted a lotus flower effulgent like a thousand blazing suns. This lotus flower is the reservoir of all conditioned souls, and the first living entity who came out of the lotus flower was the omnipotent Brahmā",
    "purport": [
        {
            "type": "normal",
