var text = {
    ...
    "verses": [
        {
            "roman": "rajaḥ-pradhānān mahatas\ntri-liṅgo daiva-coditāt\njātaḥ sasarja bhūtādir\nviyad-ādīni pañcaśaḥ\n"
        }
    ],
    "synonyms": "rajaḥ-pradhānāt—in which the element of rajas, or passion, predominates; mahataḥ—from the mahat-tattva; tri-liṅgaḥ—of three kinds; daiva-coditāt—impelled by superior authority; jātaḥ—was born; sasarja—evolved; bhūta-ādiḥ—the false ego (origin of the material elements); viyat—the ether; ādīni—beginning with; pañcaśaḥ—in groups of five.",
    "translation": "As impelled by the destiny of the jīva, the false ego, which is of three kinds, evolved from the mahat-tattva, in which the element of rajas predominates. From the ego, in turn, evolved many groups of five principles.",
    "purport": [
        {
            "type": "normal",
