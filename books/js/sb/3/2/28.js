var text = {
    ...
    "verses": [
        {
            "roman": "kaumārīṁ darśayaṁś ceṣṭāṁ\nprekṣaṇīyāṁ vrajaukasām\nrudann iva hasan mugdha-\nbāla-siṁhāvalokanaḥ\n"
        }
    ],
    "synonyms": "kaumārīm—just suitable to childhood; darśayan—while showing; ceṣṭām—activities; prekṣaṇīyām—worthy to be seen; vraja-okasām—by the inhabitants of the land of Vṛndāvana; rudan—crying; iva—just like; hasan—laughing; mugdha—struck with wonder; bāla-siṁha—lion cub; avalokanaḥ—looking like that.",
    "translation": "When the Lord displayed His activities just suitable for childhood, He was visible only to the residents of Vṛndāvana. Sometimes He would cry and sometimes laugh, just like a child, and while so doing He would appear like a lion cub.",
    "purport": [
        {
            "type": "normal",
