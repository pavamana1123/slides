var text = {
    ...
    "purport": [
        ...
        {
            "type": "normal",
            "content": "The words dharmeṇobhaya-cihnena mean that the bhakti-yoga process contains two symptoms, namely attachment for the Supreme Lord and detachment from all material affinities. There are two symptoms of advancement in the process of devotional service, just as there are two processes taking place while eating. A hungry man feels strength and satisfaction from eating, and at the same time he gradually becomes detached from eating any more. Similarly, with the execution of devotional service, real knowledge develops, and one becomes detached from all material activities. In no other activity but devotional service is there such detachment from matter and attachment for the Supreme. There are nine different processes to increase this attachment to the Supreme Lord: hearing, chanting, remembering, worshiping, serving the Lord, making friendship, praying, offering everything and serving the lotus feet of the Lord. The processes for increasing detachment from material affinities are explained in verse 36."
        },
        {
            "type": "normal",
        ...
        {
            "type": "normal",
            "content": "As long as one is in the modes of material nature and is performing the duties prescribed in the scriptures, he can be elevated to higher planetary systems, where the predominating deities are material representations of the Supreme Personality of Godhead, like the sun-god, the moon-god, the air-god, Brahmā and Lord Śiva. All the different demigods are material representations of the Supreme Lord. By material activities one can approach only such demigods, as stated in Bhagavad-gītā . Yānti deva-vratā devān: those who are attached to the demigods and who perform the prescribed duties can approach the abodes of the demigods. In this way, one can go to the planet of the Pitās, or forefathers. Similarly, one who fully understands the real position of his life adopts devotional service and realizes the Supreme Personality of Godhead."
        }
    ]
}
