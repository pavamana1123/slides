var text = {
    ...
    "verses": [
        {
            "roman": "aho pāpacyamānānāṁ\nniraye svair amaṅgalaiḥ\nkālena bhūyasā nūnaṁ\nprasīdantīha devatāḥ\n"
        }
    ],
    "synonyms": "aho—oh; pāpacyamānānām—with those being much afflicted; niraye—in the hellish material entanglement; svaiḥ—their own; amaṅgalaiḥ—by misdeeds; kālena bhūyasā—after a long time; nūnam—indeed; prasīdanti—they are pleased; iha—in this world; devatāḥ—the demigods.",
    "translation": "Kardama Muni said: Oh, after a long time the demigods of this universe have become pleased with the suffering souls who are in material entanglement because of their own misdeeds.",
    "purport": [
        {
            "type": "normal",
