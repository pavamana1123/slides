var text = {
    ...
    "purport": [
        {
            "type": "normal",
            "content": "The first and foremost duty of a pilgrim is to satisfy the Supreme Lord Hari. While traveling as a pilgrim, one should not be worried about pleasing society. There is no need to depend on social formalities or occupation or dress. One should remain always absorbed in the function of pleasing the Lord. Thus sanctified by thought and action, one is able to realize the Supreme Lord by the process of a pilgrim's journey."
        }
    ]
}
