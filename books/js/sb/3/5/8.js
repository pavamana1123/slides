var text = {
    ...
    "verses": [
        {
            "roman": "yais tattva-bhedair adhiloka-nātho\nlokān alokān saha lokapālān\nacīkḷpad yatra hi sarva-sattva-\nnikāya-bhedo 'dhikṛtaḥ pratītaḥ\n"
        }
    ],
    "synonyms": "yaiḥ—by whom; tattva—truth; bhedaiḥ—by differentiation; adhiloka-nāthaḥ—the King of the kings; lokān—planets; alokān—planets of the lower region; saha—along with; loka-pālān—respective kings; acīkḷpat—planned; yatra—wherein; hi—certainly; sarva—all; sattva—existence; nikāya—living entities; bhedaḥ—difference; adhikṛtaḥ—occupied; pratītaḥ—it so appears.",
    "translation": "The Supreme King of all kings has created different planets and places of habitation where living entities are situated in terms of the modes of nature and work, and He has created their different kings and rulers.",
    "purport": [
        {
            "type": "normal",
