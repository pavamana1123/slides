var text = {
    ...
    "verses": [
        {
            "roman": "saṁvatsaraḥ parivatsara\niḍā-vatsara eva ca\nanuvatsaro vatsaraś ca\nviduraivaṁ prabhāṣyate\n"
        }
    ],
    "synonyms": "saṁvatsaraḥ—orbit of the sun; parivatsaraḥ—circumambulation of Bṛhaspati; iḍā-vatsaraḥ—orbit of the stars; eva—as they are; ca—also; anuvatsaraḥ—orbit of the moon; vatsaraḥ—one calendar year; ca—also; vidura—O Vidura; evam—thus; prabhāṣyate—they are so told.",
    "translation": "There are five different names for the orbits of the sun, moon, stars and luminaries in the firmament, and they each have their own saṁvatsara.",
    "purport": [
        {
            "type": "normal",
            "content": "The subject matters of physics, chemistry, mathematics, astronomy, time and space dealt with in the above verses of Śrīmad-Bhāgavatam are certainly very interesting to students of the particular subject, but as far as we are concerned, we cannot explain them very thoroughly in terms of technical knowledge. The subject is summarized by the statement that above all the different branches of knowledge is the supreme control of kāla, the plenary representation of the Supreme Personality of Godhead. Nothing exists without Him, and therefore everything, however wonderful it may appear to our meager knowledge, is but the work of the magical wand of the Supreme Lord. As far as time is concerned, we beg to subjoin herewith a table of timings in terms of the modern clock."
        },
        {
            "type": "normal",
            "content": "<br/>"
        ...
        {
            "type": "normal",
            "content": "The Brahma-saṁhitā (BS 5.38) affirms this control in this way:"
        },
        {
            "type": "verse",
