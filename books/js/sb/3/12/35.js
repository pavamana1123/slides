var text = {
    ...
    "verses": [
        {
            "roman": "cātur-hotraṁ karma-tantram\nupaveda-nayaiḥ saha\ndharmasya pādāś catvāras\ntathaivāśrama-vṛttayaḥ\n"
        }
    ],
    "synonyms": "cātuḥ—four; hotram—paraphernalia for sacrifice; karma—action; tantram—expansions of such activities; upaveda—supplementary to the Vedas; nayaiḥ—by logical conclusions; saha—along with; dharmasya—of religiosity; pādāḥ—principles; catvāraḥ—four; tathā eva—in the same way; āśrama—social orders; vṛttayaḥ—occupations.",
