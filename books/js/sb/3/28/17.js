var text = {
    ...
    "verses": [
        {
            "roman": "apīcya-darśanaṁ śaśvat\nsarva-loka-namaskṛtam\nsantaṁ vayasi kaiśore\nbhṛtyānugraha-kātaram\n"
        }
    ],
    "synonyms": "apīcya-darśanam—very beautiful to see; śaśvat—eternal; sarva-loka—by all the inhabitants of every planet; namaḥ-kṛtam—worshipable; santam—situated; vayasi—in youth; kaiśore—in boyhood; bhṛtya—upon His devotee; anugraha—to bestow blessings; kātaram—eager.",
