var text = {
    ...
    "verses": [
        {
            "roman": "yady asadbhiḥ pathi punaḥ\nśiśnodara-kṛtodyamaiḥ\nāsthito ramate jantus\ntamo viśati pūrvavat\n"
        }
    ],
    "synonyms": "yadi—if; asadbhiḥ—with the unrighteous; pathi—on the path; punaḥ—again; śiśna—for the genitals; udara—for the stomach; kṛta—done; udyamaiḥ—whose endeavors; āsthitaḥ—associating; ramate—enjoys; jantuḥ—the living entity; tamaḥ—darkness; viśati—enters; pūrva-vat—as before.",
