var text = {
    ...
    "verses": [
        {
            "roman": "so 'haṁ vasann api vibho bahu-duḥkha-vāsaṁ\ngarbhān na nirjigamiṣe bahir andha-kūpe\nyatropayātam upasarpati deva-māyā\nmithyā matir yad-anu saṁsṛti-cakram etat\n"
        }
    ],
    "synonyms": "saḥ aham—I myself; vasan—living; api—although; vibho—O Lord; bahu-duḥkha—with many miseries; vāsam—in a condition; garbhāt—from the abdomen; na—not; nirjigamiṣe—I wish to depart; bahiḥ—outside; andha-kūpe—in the blind well; yatra—where; upayātam—one who goes there; upasarpati—she captures; deva-māyā—the external energy of the Lord; mithyā—false; matiḥ—identification; yat—which māyā; anu—according to; saṁsṛti—of continual birth and death; cakram—cycle; etat—this.",
