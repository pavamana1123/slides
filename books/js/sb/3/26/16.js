var text = {
    ...
    "verses": [
        {
            "roman": "prabhāvaṁ pauruṣaṁ prāhuḥ\nkālam eke yato bhayam\nahaṅkāra-vimūḍhasya\nkartuḥ prakṛtim īyuṣaḥ\n"
        }
    ],
    "synonyms": "prabhāvam—the influence; pauruṣam—of the Supreme Personality of Godhead; prāhuḥ—they have said; kālam—the time factor; eke—some; yataḥ—from which; bhayam—fear; ahaṅkāra-vimūḍhasya—deluded by false ego; kartuḥ—of the individual soul; prakṛtim—material nature; īyuṣaḥ—having contacted.",
    "translation": "The influence of the Supreme Personality of Godhead is felt in the time factor, which causes fear of death due to the false ego of the deluded soul who has contacted material nature.",
    "purport": [
        {
            "type": "normal",
            "content": "The living entity's fear of death is due to his false ego of identifying with the body. Everyone is afraid of death. Actually there is no death for the spirit soul, but due to our absorption in the identification of body as self, the fear of death develops. It is also stated in the Śrīmad-Bhāgavatam , bhayaṁ dvitīyābhiniveśataḥ syāt. Dvitīya refers to matter, which is beyond spirit. Matter is the secondary manifestation of spirit, for matter is produced from spirit. Just as the material elements described are caused by the Supreme Lord, or the Supreme Spirit, the body is also a product of the spirit soul. Therefore, the material body is called dvitīya, or \"the second.\" One who is absorbed in this second element or second exhibition of the spirit is afraid of death. When one is fully convinced that he is not his body, there is no question of fearing death, since the spirit soul does not die."
        },
        {
            "type": "normal",
