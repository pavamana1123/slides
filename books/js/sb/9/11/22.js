var text = {
    ...
    "verses": [
        {
            "roman": "sa yaiḥ spṛṣṭo 'bhidṛṣṭo vā\nsaṁviṣṭo 'nugato 'pi vā\nkosalās te yayuḥ sthānaṁ\nyatra gacchanti yoginaḥ\n"
        }
    ],
    "synonyms": "saḥ—He, Lord Rāmacandra; yaiḥ—by which persons; spṛṣṭaḥ—touched; abhidṛṣṭaḥ—seen; vā—either; saṁviṣṭaḥ—eating together, lying together; anugataḥ—followed as servants; api vā—even; kosalāḥ—all those inhabitants of Kosala; te—they; yayuḥ—departed; sthānam—to the place; yatra—wherein; gacchanti—they go; yoginaḥ—all the bhakti-yogis.",
    "translation": "Lord Rāmacandra returned to His abode, to which bhakti-yogīs are promoted. This is the place to which all the inhabitants of Ayodhyā went after they served the Lord in His manifest pastimes by offering Him obeisances, touching His lotus feet, fully observing Him as a fatherlike King, sitting or lying down with Him like equals, or even just accompanying Him.",
    "purport": [
        {
            "type": "normal",
