var text = {
    ...
    "verses": [
        {
            "roman": "bhavāya nāśāya ca karma kartuṁ\nśokāya mohāya sadā bhayāya\nsukhāya duḥkhāya ca deha-yogam\navyakta-diṣṭaṁ janatāṅga dhatte\n"
        }
    ],
    "synonyms": "bhavāya—for birth; nāśāya—for death; ca—also; karma—activity; kartum—to do; śokāya—for bereavement; mohāya—for illusion; sadā—always; bhayāya—for fear; sukhāya—for happiness; duḥkhāya—for distress; ca—also; deha-yogam—connection with a material body; avyakta—by the Supreme Personality of Godhead; diṣṭam—directed; janatā—the living entities; aṅga—O Priyavrata; dhatte—accept.",
    "translation": "My dear Priyavrata, by the order of the Supreme Personality of Godhead, all living entities accept different types of bodies for birth and death, activity, lamentation, illusion, fear of future dangers, and happiness and distress.",
    "purport": [
        {
            "type": "normal",
            "content": "Every living entity who has come to this material world has come here for material enjoyment, but according to his own karma, activities, he must accept a certain type of body given to him by material nature under the order of the Supreme Personality of Godhead. As stated in Bhagavad-gītā :"
        },
        {
            "type": "verse",
