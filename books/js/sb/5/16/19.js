var text = {
    ...
    "purport": [
        {
            "type": "normal",
            "content": "We can only imagine how much juice there might be in a fruit that is the size of an elephant but has a very tiny seed. Naturally the juice from the broken jambū fruits forms waterfalls and floods the entire land of Ilāvṛta. That juice produces an immense quantity of gold, as will be explained in the next verses."
        }
    ]
}
