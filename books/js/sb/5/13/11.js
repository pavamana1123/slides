var text = {
    ...
    "verses": [
        {
            "roman": "kvacic ca śītātapa-vāta-varṣa-\npratikriyāṁ kartum anīśa āste\nkvacin mitho vipaṇan yac ca kiñcid\nvidveṣam ṛcchaty uta vitta-śāṭhyāt\n"
        }
    ],
    "synonyms": "kvacit—sometimes; ca—also; śīta-ātapa-vāta-varṣa—of freezing cold, scorching heat, strong wind and excessive rainfall; pratikriyām—counteraction; kartum—to do; anīśaḥ—being unable; āste—remains in misery; kvacit—sometimes; mithaḥ—one another; vipaṇan—selling; yat ca—whatever; kiñcit—a little bit; vidveṣam—mutual enmity; ṛcchati—obtain; uta—it is so said; vitta-śāṭhyāt—because of cheating one another merely for money.",
    "translation": "Sometimes the living entity is busy counteracting the natural disturbances of freezing cold, scorching heat, strong wind, excessive rainfall and so forth. When he is unable to do so, he becomes very unhappy. Sometimes he is cheated in business transactions one after another. In this way, by cheating, living entities create enmity among themselves.",
    "purport": [
        {
            "type": "normal",
