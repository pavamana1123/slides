var text = {
    ...
    "verses": [
        {
            "roman": "brahmā bhavo bhavantaś ca\nmanavo vibudheśvarāḥ\nvibhūtayo mama hy etā\nbhūtānāṁ bhūti-hetavaḥ\n"
        }
    ],
    "synonyms": "brahmā—Lord Brahmā; bhavaḥ—Lord Śiva; bhavantaḥ—all of you prajāpatis; ca—and; manavaḥ—the Manus; vibudha-īśvarāḥ—all the different demigods (such as the sun, the moon, Venus, Mars and Jupiter, who are all in charge of various activities for the welfare of the world); vibhūtayaḥ—expansions of energy; mama—My; hi—indeed; etāḥ—all these; bhūtānām—of all the living entities; bhūti—of welfare; hetavaḥ—causes.",
    "translation": "Lord Brahmā, Lord Śiva, the Manus, all the other demigods in the higher planetary systems, and you prajāpatis, who are increasing the population, are working for the benefit of all living entities. Thus you expansions of My marginal energy are incarnations of My various qualities.",
    "purport": [
        {
            "type": "normal",
        ...
        {
            "type": "verse",
            "content": "viśeṣa-vyakti-pātratvādbrahmādyās tu vibhūtayaḥ\ntad-antaryāmiṇaś caivamatsyādyā vibhavāḥ smṛtāḥ"
        },
        {
            "type": "normal",
            "content": "From Lord Brahmā down, all the living entities engaged in the service of the Lord are extraordinary and are called vibhūti. As the Lord says in Bhagavad-gītā :"
        },
        {
            "type": "verse",
