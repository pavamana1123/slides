var text = {
    ...
    "verses": [
        {
            "roman": "tasmin vinihate yūyaṁ\ntejo-'strāyudha-sampadaḥ\nbhūyaḥ prāpsyatha bhadraṁ vo\nna hiṁsanti ca mat-parān\n"
        }
    ],
    "synonyms": "tasmin—when he (Vṛtrāsura); vinihate—is killed; yūyam—all of you; tejaḥ—power; astra—arrows; āyudha—other weapons; sampadaḥ—and opulence; bhūyaḥ—again; prāpsyatha—will obtain; bhadram—all good fortune; vaḥ—unto you; na—not; hiṁsanti—hurt; ca—also; mat-parān—My devotees.",
    "translation": "When Vṛtrāsura is killed because of My spiritual strength, you will regain your strength, weapons and wealth. Thus there will be all good fortune for all of you. Although Vṛtrāsura can destroy all the three worlds, do not fear that he will harm you. He is also a devotee and will never be envious of you.",
    "purport": [
        {
            "type": "normal",
