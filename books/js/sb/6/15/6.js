var text = {
    ...
    "verses": [
        {
            "roman": "bhūtair bhūtāni bhūteśaḥ\nsṛjaty avati hanti ca\nātma-sṛṣṭair asvatantrair\nanapekṣo 'pi bālavat\n"
        }
    ],
    "synonyms": "bhūtaiḥ—by some living beings; bhūtāni—other living entities; bhūta-īśaḥ—the Supreme Personality of Godhead, the master of everything; sṛjati—creates; avati—maintains; hanti—kills; ca—also; ātma-sṛṣṭaiḥ—who are created by Him; asvatantraiḥ—not independent; anapekṣaḥ—not interested (in creation); api—although; bāla-vat—like a boy.",
    ...
    "purport": [
        {
            "type": "normal",
            "content": "No one can independently create, maintain or annihilate. Bhagavad-gītā  therefore says:"
        },
        {
            "type": "verse",
