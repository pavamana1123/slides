var text = {
    ...
    "purport": [
        ...
        {
            "type": "normal",
            "content": "As a fire, although existing in one place, can expand its light and heat everywhere, so the omnipotent Lord, the Supreme Personality of Godhead, although situated in His spiritual abode, expands Himself everywhere, in both the material and spiritual worlds, by His various energies. Since both cause and effect are the Supreme Lord, there is no difference between cause and effect. Consequently the ornaments and weapons of the Lord, being expansions of His spiritual energy, are not different from Him. There is no difference between the Lord and His variously presented energies. This is also confirmed in the Padma Purāṇa:"
        },
        {
            "type": "verse",
