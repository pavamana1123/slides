var text = {
    ...
    "purport": [
        {
            "type": "normal",
            "content": "Nārada Muni had mentioned a kingdom where there is only one king with no competitor. The complete spiritual world, and specifically the cosmic manifestation, has only one proprietor or enjoyer—the Supreme Personality of Godhead, who is beyond this material manifestation. The Lord has therefore been described as turya, existing on the fourth platform. He has also been described as abhava. The word bhava, which means \"takes birth,\" comes from the word bhū, \"to be.\" As stated in Bhagavad-gītā ). Nārada Muni advises that human beings not waste their time simply jumping like cats and monkeys, without real benefit. The duty of the human being is to understand the Supreme Personality of Godhead."
        }
    ]
}
