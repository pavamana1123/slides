var text = {
    "info": {
        "id": "sb/6/16/20",
        "prevId": "sb/6/16/18-19",
        "nextId": "sb/6/16/21"
    },
    "verses": [
        {
            "roman": "ātmānandānubhūtyaiva\nnyasta-śakty-ūrmaye namaḥ\nhṛṣīkeśāya mahate\nnamas te 'nanta-mūrtaye\n"
        }
    ],
    "synonyms": "ātma-ānanda—of Your personal bliss; anubhūtyā—by perception; eva—certainly; nyasta—given up; śakti-ūrmaye—the waves of material nature; namaḥ—respectful obeisances; hṛṣīkeśāya—unto the supreme controller of the senses; mahate—unto the Supreme; namaḥ—respectful obeisances; te—unto You; ananta—unlimited; mūrtaye—whose expansions.",
