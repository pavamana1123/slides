var text = {
    ...
    "verses": [
        {
            "roman": "na hi bhagavann aghaṭitam idaṁ\ntvad-darśanān nṛṇām akhila-pāpa-kṣayaḥ\nyan-nāma sakṛc chravaṇāt\npukkaśo 'pi vimucyate saṁsārāt\n"
        }
    ],
    "synonyms": "na—not; hi—indeed; bhagavan—O my Lord; aghaṭitam—not occurred; idam—this; tvat—of You; darśanāt—by seeing; nṛṇām—of all human beings; akhila—all; pāpa—of sins; kṣayaḥ—annihilation; yat-nāma—whose name; sakṛt—only once; śravaṇāt—by hearing; pukkaśaḥ—the lowest class, the caṇḍāla; api—also; vimucyate—is delivered; saṁsārāt—from the entanglement of material existence.",
    "translation": "My Lord, it is not impossible for one to be immediately freed from all material contamination by seeing You. Not to speak of seeing You personally, merely by hearing the holy name of Your Lordship only once, even caṇḍālas, men of the lowest class, are freed from all material contamination. Under the circumstances, who will not be freed from material contamination simply by seeing You?",
    "purport": [
        {
            "type": "normal",
            "content": "As stated in the Śrīmad-Bhāgavatam , yan-nāma-śruti-mātreṇa pumān bhavati nirmalaḥ: simply by hearing the holy name of the Lord, one is immediately purified. Therefore, in this age of Kali, when all people are very contaminated, the chanting of the holy name of the Lord is recommended as the only means of improvement."
        },
        {
            "type": "verse",
