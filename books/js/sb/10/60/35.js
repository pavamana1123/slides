var text = {
    ...
    "verses": [
        {
            "roman": "satyaṁ bhayād iva guṇebhya urukramāntaḥ\nśete samudra upalambhana-mātra ātmā\nnityaṁ kad-indriya-gaṇaiḥ kṛta-vigrahas tvaṁ\ntvat-sevakair nṛpa-padaṁ vidhutaṁ tamo 'ndham\n"
        }
    ],
    "synonyms": "satyam—true; iva—as if; guṇebhyaḥ—of the material modes; urukrama—O You who perform transcendental feats; antaḥ—within; śete—You have lain down; samudre—in the ocean; upalambhana-mātraḥ—pure awareness; ātma—the Supreme Soul; nityam—always; kat—bad; indriya-gaṇaiḥ—against all the material senses; kṛta-vigrahaḥ—battling; tvam—You; tvat—Your; sevakaiḥ—by the servants; nṛpa—of a king; padam—the position; vidhutam—rejected; tamaḥ—darkness; andham—blind.",
