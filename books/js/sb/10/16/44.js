var text = {
    "info": {
        "id": "sb/10/16/44",
        "prevId": "sb/10/16/42-43",
        "nextId": "sb/10/16/45"
    },
    "verses": [
        {
            "roman": "namaḥ pramāṇa-mūlāya\nkavaye śāstra-yonaye\npravṛttāya nivṛttāya\nnigamāya namo namaḥ\n"
        }
    ],
    "synonyms": "namaḥ—obeisances; pramāṇa—of authoritative evidence; mūlāya—to the basis; kavaye—to the author; śāstra—of the revealed scripture; yonaye—to the source; pravṛttāya—which encourages sense gratification; nivṛttāya—which encourages renunciation; nigamāya—to Him who is the origin of both kinds of scripture; namaḥ namaḥ—repeated obeisances.",
