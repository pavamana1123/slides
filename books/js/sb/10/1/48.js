var text = {
    ...
    "verses": [
        {
            "roman": "mṛtyur buddhimatāpohyo\nyāvad buddhi-balodayam\nyady asau na nivarteta\nnāparādho 'sti dehinaḥ\n"
        }
    ],
    "synonyms": "mṛtyuḥ—death; buddhi-matā—by an intelligent person; apohyaḥ—should be avoided; yāvat—as long as; buddhi-bala-udayam—intelligence and bodily strength are present; yadi—if; asau—that (death); na nivarteta—cannot be checked; na—not; aparādhaḥ—offense; asti—there is; dehinaḥ—of the person in danger of death.",
