var text = {
    ...
    "verses": [
        {
            "roman": "saraḥsv aśānta-rodhaḥsu\nnyūṣur aṅgāpi sārasāḥ\ngṛheṣv aśānta-kṛtyeṣu\ngrāmyā iva durāśayāḥ\n"
        }
    ],
    "synonyms": "saraḥsu—upon the lakes; aśānta—disturbed; rodhaḥsu—whose banks; nyūṣuḥ—continued to dwell; aṅga—my dear King; api—indeed; sārasāḥ—the cranes; gṛheṣu—in their homes; aśānta—feverish; kṛtyeṣu—where activities are performed; grāmyāḥ—materialistic men; durāśayāḥ—whose minds are contaminated.",
    "translation": "The cranes continued dwelling on the shores of the lakes, although the shores were agitated during the rainy season, just as materialistic persons with contaminated minds always remain at home, despite the many disturbances there.",
    "purport": [
        {
            "type": "normal",
