var text = {
    ...
    "purport": [
        {
            "type": "normal",
            "content": "As stated in Bhagavad-gītā : even one who is very much advanced in spiritual realization must still execute the Vedic principles. Even in the lowest stage, the karmīs are advised to work for the sake of the Lord."
        },
        {
            "type": "verse",
        ...
        {
            "type": "normal",
            "content": "\"In this age of quarrel and hypocrisy the only means of deliverance is chanting the holy name of the Lord. There is no other way. There is no other way. There is no other way.\" The Kṛṣṇa consciousness movement is therefore teaching people all over the world how to chant the Hare Kṛṣṇa mantra, and this has proved very much effective in all places at all times. The Supreme Personality of Godhead appears in order to teach us Vedic principles intended for understanding Him (vedaiś ca sarvair aham eva vedyaḥ ). We should learn how to act from Bhagavad-gītā, which explains everything for human understanding. Thus we can become happy even in this age of Kali."
        }
    ]
}
