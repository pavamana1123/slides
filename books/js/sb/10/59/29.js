var text = {
    ...
    "translation": "Desiring to create, O unborn master, You increase and then assume the mode of passion. You do likewise with the mode of ignorance when You wish to annihilate the universe and with goodness when You wish to maintain it. Nonetheless, You remain uncovered by these modes. You are time, the pradhāna, and the puruṣa, O Lord of the universe, yet still You are separate and distinct.",
    "purport": [
        {
            "type": "normal",
            "content": "The word jagataḥ in the third line of this verse indicates that the functions of creation, maintenance and annihilation are here mentioned in a cosmic context."
        },
        {
            "type": "normal",
            "content": "The word utkaṭam indicates that when a particular function is being carried out, whether universal creation, maintenance or annihilation, the particular material quality associated with that function becomes predominant."
        }
    ]
}
