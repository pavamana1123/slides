var text = {
    ...
    "verses": [
        {
            "roman": "kṛṣṇas tv anyatamaṁ rūpaṁ\ngopa-viśrambhaṇaṁ gataḥ\nśailo 'smīti bruvan bhūri\nbalim ādad bṛhad-vapuḥ\n"
        }
    ],
    "synonyms": "kṛṣṇaḥ—Lord Kṛṣṇa; tu—and then; anyatamam—another; rūpam—transcendental form; gopa-viśrambhaṇam—for generating the faith of the cowherds; gataḥ—assumed; śailaḥ—the mountain; asmi—I am, iti-these words; bruvan—saying; bhūri—abundant; balim—the offerings; ādat—He devoured; bṛhat-vapuḥ—in His huge form.",
    "translation": "Kṛṣṇa then assumed an unprecedented, huge form to instill faith in the cowherd men. Declaring \"I am Govardhana Mountain!\" He ate the abundant offerings.",
    "purport": [
        {
            "type": "normal",
