var text = {
    ...
    "purport": [
        ...
        {
            "type": "normal",
            "content": "The example is given here that even if the most learned scholars could someday count the particles of earth, snow and light, they would still fail to understand the qualities of the Lord. In this example earth, snow and light are progressively more subtle; thus it is to be understood that there is an increasing difficulty in counting their virtually infinite particles."
        },
        {
            "type": "normal",
            "content": "According to Śrīla Viśvanātha Cakravartī Ṭhākura, great personalities like Lord Saṅkarṣaṇa actually have counted the number of atoms on the earth, and even the molecules in the entire universe. Yet even such a personality as Saṅkarṣaṇa, who has been continuously chanting the glories of the Lord since time immemorial, has not even approached a final count of those glories."
        },
        {
            "type": "normal",
