var text = {
    ...
    "verses": [
        {
            "roman": "viśvaṁ yad etat sva-tanau niśānte\nyathāvakāśaṁ puruṣaḥ paro bhavān\nbibharti so 'yaṁ mama garbhago 'bhūd\naho nṛ-lokasya viḍambanaṁ hi tat\n"
        }
    ],
    "synonyms": "viśvam—the entire cosmic manifestation; yat etat—containing all moving and nonmoving creations; sva-tanau—within Your body; niśā-ante—at the time of devastation; yathā-avakāśam—shelter in Your body without difficulty; puruṣaḥ—the Supreme Personality of Godhead; paraḥ—transcendental; bhavān—Your Lordship; bibharti—keep; saḥ—that (Supreme Personality of Godhead); ayam—this form; mama—my; garbha-gaḥ—came within my womb; abhūt—it so happened; aho—alas; nṛ-lokasya—within this material world of living entities; viḍambanam—it is impossible to think of; hi—indeed; tat—that (kind of conception).",
    "translation": "At the time of devastation, the entire cosmos, containing all created moving and nonmoving entities, enters Your transcendental body and is held there without difficulty. But now this transcendental form has taken birth from my womb. People will not be able to believe this, and I shall become an object of ridicule.",
    "purport": [
        {
            "type": "normal",
            "content": "As explained in Caitanya-caritāmṛta, loving service to the Personality of Godhead is of two different kinds: aiśvarya-pūrṇa, full of opulence, and aiśvarya-śīthila, without opulence. Real love of Godhead begins with aiśvarya-śīthila, simply on the basis of pure love."
        },
        {
            "type": "verse",
