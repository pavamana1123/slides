var text = {
    ...
    "verses": [
        {
            "roman": "ataḥ paraṁ sūkṣmatamam\navyaktaṁ nirviśeṣaṇam\nanādi-madhya-nidhanaṁ\nnityaṁ vāṅ-manasaḥ param\n"
        }
    ],
    "synonyms": "ataḥ—therefore; param—transcendental; sūkṣmatamam—finer than the finest; avyaktam—unmanifested; nirviśeṣaṇam—without material features; anādi—without beginning; madhya—without an intermediate stage; nidhanam—without end; nityam—eternal; vāk—words; manasaḥ—of the mind; param—transcendental.",
