var text = {
    ...
    "verses": [
        {
            "roman": "vivakṣor mukhato bhūmno\nvahnir vāg vyāhṛtaṁ tayoḥ\njale caitasya suciraṁ\nnirodhaḥ samajāyata\n"
        }
    ],
    "synonyms": "vivakṣoḥ—when there was a need to speak; mukhataḥ—from the mouth; bhūmnaḥ—of the Supreme; vahniḥ—fire or the controlling deity of fire; vāk—vibration; vyāhṛtam—speeches; tayoḥ—by both; jale—in the water; ca—however; etasya—of all these; suciram—a very, very long time; nirodhaḥ—suspension; samajāyata—did continue.",
