var text = {
    ...
    "verses": [
        {
            "roman": "yo 'dhyātmiko 'yaṁ puruṣaḥ\nso 'sāv evādhidaivikaḥ\nyas tatrobhaya-vicchedaḥ\npuruṣo hy ādhibhautikaḥ\n"
        }
    ],
    "synonyms": "yaḥ—one who; adhyātmikaḥ—is possessed of the sense organs; ayam—this; puruṣaḥ—personality; saḥ—he; asau—that; eva—also; adhidaivikaḥ—controlling deity; yaḥ—that which; tatra—there; ubhaya—of both; vicchedaḥ—separation; puruṣaḥ—person; hi—for; ādhibhautikaḥ—the visible body or the embodied living entity.",
    "translation": "The individual person possessing different instruments of senses is called the adhyātmic person, and the individual controlling deity of the senses is called adhidaivic. The embodiment seen on the eyeballs is called the adhibhautic person.",
    "purport": [
        {
            "type": "normal",
            "content": "The supreme controlling summum bonum is the Personality of Godhead in His plenary portion of Paramātmā, or the Supersoul manifestation. In the Bhagavad-gītā  it is said:"
        },
        {
            "type": "verse",
