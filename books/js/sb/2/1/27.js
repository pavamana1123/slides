var text = {
    ...
    "verses": [
        {
            "roman": "dve jānunī sutalaṁ viśva-mūrter\nūru-dvayaṁ vitalaṁ cātalaṁ ca\nmahītalaṁ taj-jaghanaṁ mahīpate\nnabhastalaṁ nābhi-saro gṛṇanti\n"
        }
    ],
    "synonyms": "dve—two; jānunī—two knees; sutalam—the planetary system named Sutala; viśva-mūrteḥ—of the universal form; ūru-dvayam—the two thighs; vitalam—the planetary system named Vitala; ca—also; atalam—the planets named Atala; ca—and; mahītalam—the planetary system named Mahītala; tat—of that; jaghanam—the hips; mahīpate—O King; nabhastalam—outer space; nābhi-saraḥ—the depression of the navel; gṛṇanti—they take it so.",
