var text = {
    ...
    "verses": [
        {
            "roman": "itthaṁ munis tūparamed vyavasthito\nvijñāna-dṛg-vīrya-surandhitāśayaḥ\nsva-pārṣṇināpīḍya gudaṁ tato 'nilaṁ\nsthāneṣu ṣaṭsūnnamayej jita-klamaḥ\n"
        }
    ],
    "synonyms": "ittham—thus, by Brahman realization; muniḥ—the philosopher; tu—but; uparamet—should retire; vyavasthitaḥ—well situated; vijñāna-dṛk—by scientific knowledge; vīrya—strength; su-randhita—well regulated; āśayaḥ—aim of life; sva-pārṣṇinā—with the heel of one's foot; āpīḍya—by blocking; gudam—the air hole; tataḥ—thereafter; anilam—life air; sthāneṣu—in the places; ṣaṭsu—six primary; unnamayet—must be lifted; jita-klamaḥ—by extinguishing material desires.",
