var text = {
    ...
    "verses": [
        {
            "roman": "ghrāṇena gandhaṁ rasanena vai rasaṁ\nrūpaṁ ca dṛṣṭyā śvasanaṁ tvacaiva\nśrotreṇa copetya nabho-guṇatvaṁ\nprāṇena cākūtim upaiti yogī\n"
        }
    ],
    "synonyms": "ghrāṇena—by smelling; gandham—aroma; rasanena—by taste; vai—exactly; rasam—palate; rūpam—forms; ca—also; dṛṣṭyā—by vision; śvasanam—contact; tvacā—touch; eva—as it were; śrotreṇa—by vibration of the ear; ca—also; upetya—by achieving; nabhaḥ-guṇatvam—identification of ether; prāṇena—by sense organs; ca—also; ākūtim—material activities; upaiti—attains; yogī—the devotee.",
    "translation": "The devotee thus surpasses the subtle objects of different senses like aroma by smelling, the palate by tasting, vision by seeing forms, touch by contacting, the vibrations of the ear by ethereal identification, and the sense organs by material activities.",
    "purport": [
        {
            "type": "normal",
