var text = {
    ...
    "verses": [
        {
            "roman": "manaḥ sva-buddhyāmalayā niyamya\nkṣetra-jña etāṁ ninayet tam ātmani\nātmānam ātmany avarudhya dhīro\nlabdhopaśāntir virameta kṛtyāt\n"
        }
    ],
    "synonyms": "manaḥ—the mind; sva-buddhyā—by his own intelligence; amalayā—unalloyed; niyamya—by regulating; kṣetra-jñe—unto the living entity; etām—all of them; ninayet—merge; tam—that; ātmani—the self; ātmānam—the self; ātmani—in the Superself; avarudhya—being locked up; dhīraḥ—the fully satisfied; labdha-upaśāntiḥ—one who has attained full bliss; virameta—ceases from; kṛtyāt—all other activities.",
