var text = {
    ...
    "synonyms": "śrī-śukaḥ uvāca—Śrī Śukadeva Gosvāmī said; ātma—the Supreme Personality of Godhead; māyām—energy; ṛte—without; rājan—O King; parasya—of the pure soul; anubhava-ātmanaḥ—of the purely conscious; na—never; ghaṭeta—it can so happen; artha—meaning; sambandhaḥ—relation with the material body; svapna—dream; draṣṭuḥ—of the seer; iva—like; añjasā—completely.",
    "translation": "Śrī Śukadeva Gosvāmī said: O King, unless one is influenced by the energy of the Supreme Personality of Godhead, there is no meaning to the relationship of the pure soul in pure consciousness with the material body. That relationship is just like a dreamer's seeing his own body working.",
    "purport": [
        {
            "type": "normal",
            "content": "Mahārāja Parīkṣit's question as to how a living entity began his material life, although he is apart from the material body and mind, is perfectly answered. The spirit soul is distinct from the material conception of his life, but he is absorbed in such a material conception because of being influenced by the external energy of the Lord, called ātma-māyā. This has already been explained in the First Canto in connection with Vyāsadeva's realization of the Supreme Lord and His external energy. The external energy is controlled by the Lord, and the living entities are controlled by the external energy—by the will of the Lord. Therefore, although the living entity is purely conscious in his pure state, he is subordinate to the will of the Lord in being influenced by the external energy of the Lord. In the Bhagavad-gītā  also the same thing is confirmed; the Lord is present within the heart of every living entity, and all the living entity's consciousness and forgetfulness are influenced by the Lord."
        },
        {
            "type": "normal",
