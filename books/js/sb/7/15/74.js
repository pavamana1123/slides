var text = {
    ...
    "verses": [
        {
            "roman": "dharmas te gṛha-medhīyo\nvarṇitaḥ pāpa-nāśanaḥ\ngṛhastho yena padavīm\nañjasā nyāsinām iyāt\n"
        }
    ],
    "synonyms": "dharmaḥ—that religious process; te—to you; gṛha-medhīyaḥ—although attached to household life; varṇitaḥ—explained (by me); pāpa-nāśanaḥ—the destruction of sinful reactions; gṛhasthaḥ—a person in household life; yena—by which; padavīm—the position; añjasā—very easily; nyāsinām—of those in the renounced order of life; iyāt—can obtain.",
    "translation": "The process of chanting the holy name of the Lord is so powerful that by this chanting even householders [gṛhasthas] can very easily gain the ultimate result achieved by persons in the renounced order. Mahārāja Yudhiṣṭhira, I have now explained to you that process of religion.",
    "purport": [
        {
            "type": "normal",
