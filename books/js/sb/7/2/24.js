var text = {
    ...
    "verses": [
        {
            "roman": "evaṁ guṇair bhrāmyamāṇe\nmanasy avikalaḥ pumān\nyāti tat-sāmyatāṁ bhadre\nhy aliṅgo liṅgavān iva\n"
        }
    ],
    "synonyms": "evam—in this way; guṇaiḥ—by the modes of material nature; bhrāmyamāṇe—when shaken; manasi—the mind; avikalaḥ—changeless; pumān—the living entity; yāti—approaches; tat-sāmyatām—the same condition of agitation as the mind; bhadre—O my gentle mother; hi—indeed; aliṅgaḥ—without a subtle or gross body; liṅga-vān—possessing a material body; iva—as if.",
    "translation": "In the same way, O my gentle mother, when the mind is agitated by the movements of the modes of material nature, the living entity, although freed from all the different phases of the subtle and gross bodies, thinks that he has changed from one condition to another.",
    "purport": [
        {
            "type": "normal",
