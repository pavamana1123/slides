var text = {
    ...
    "verses": [
        {
            "roman": "nanv agniḥ pramadā nāma\nghṛta-kumbha-samaḥ pumān\nsutām api raho jahyād\nanyadā yāvad-artha-kṛt\n"
        }
    ],
    "synonyms": "nanu—certainly; agniḥ—the fire; pramadā—the woman (one who bewilders the mind of man); nāma—the very name; ghṛta-kumbha—a pot of butter; samaḥ—like; pumān—a man; sutām api—even one's daughter; rahaḥ—in a secluded place; jahyāt—one must not associate with; anyadā—with other women also; yāvat—as much as; artha-kṛt—required.",
    ...
    "purport": [
        {
            "type": "normal",
            "content": "If a butter pot and fire are kept together, the butter within the pot will certainly melt. Woman is compared to fire, and man is compared to a butter pot. However advanced one may be in restraining the senses, it is almost impossible for a man to keep himself controlled in the presence of a woman, even if she is his own daughter, mother or sister. Indeed, his mind is agitated even if one is in the renounced order of life. Therefore, Vedic civilization carefully restricts mingling between men and women. If one cannot understand the basic principle of restraining association between man and woman, he is to be considered an animal. That is the purport of this verse."
        }
    ]
}
