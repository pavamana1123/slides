var text = {
    ...
    "verses": [
        {
            "roman": "kāmān kāmayate kāmyair\nyad-artham iha pūruṣaḥ\nsa vai dehas tu pārakyo\nbhaṅguro yāty upaiti ca\n"
        }
    ],
    "synonyms": "kāmān—things for sense gratification; kāmayate—one desires; kāmyaiḥ—by different desirable actions; yat—of which; artham—for the purpose; iha—in this material world; pūruṣaḥ—the living entity; saḥ—that; vai—indeed; dehaḥ—body; tu—but; pārakyaḥ—belongs to others (the dogs, vultures, etc.); bhaṅguraḥ—perishable; yāti—goes away; upaiti—embraces the spirit soul; ca—and.",
    "translation": "A living entity desires comfort for his body and makes many plans for this purpose, but actually the body is the property of others. Indeed, the perishable body embraces the living entity and then leaves him aside.",
    "purport": [
        {
            "type": "normal",
