var text = {
    ...
    "verses": [
        {
            "roman": "sukhāya duḥkha-mokṣāya\nsaṅkalpa iha karmiṇaḥ\nsadāpnotīhayā duḥkham\nanīhāyāḥ sukhāvṛtaḥ\n"
        }
    ],
    "synonyms": "sukhāya—for achieving happiness by a so-called higher standard of life; duḥkha-mokṣāya—for becoming free from misery; saṅkalpaḥ—the determination; iha—in this world; karmiṇaḥ—of the living entity trying for economic development; sadā—always; āpnoti—achieves; īhayā—by activity or ambition; duḥkham—only unhappiness; anīhāyāḥ—and from not desiring economic development; sukha—by happiness; āvṛtaḥ—covered.",
    ...
    "purport": [
        {
            "type": "normal",
            "content": "Every conditioned soul is bound by the laws of material nature, as described in Bhagavad-gītā (prakṛteḥ kriyamāṇāni guṇaiḥ karmāṇi sarvaśaḥ ). Everyone has achieved a certain type of body given by material nature according to the instructions of the Supreme Personality of Godhead."
        },
        {
            "type": "verse",
