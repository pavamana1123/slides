var text = {
    ...
    "verses": [
        {
            "roman": "iti śuśruma nirbandhaṁ\ntapaḥ paramam āsthitaḥ\nvidhatsvānantaraṁ yuktaṁ\nsvayaṁ tri-bhuvaneśvara\n"
        }
    ],
    "synonyms": "iti—in this way; śuśruma—we have heard; nirbandham—strong determination; tapaḥ—austerity; paramam—very severe; āsthitaḥ—is situated in; vidhatsva—please take steps; anantaram—as soon as possible; yuktam—befitting; svayam—yourself; tri-bhuvana-īśvara—O master of the three worlds.",
    "translation": "O lord, we have heard from reliable sources that in order to obtain your post, Hiraṇyakaśipu is now engaged in severe austerity. You are the master of the three worlds. Please, without delay, take whatever steps you deem appropriate.",
    "purport": [
        {
            "type": "normal",
