var text = {
    ...
    "purport": [
        {
            "type": "normal",
            "content": "The Vedic ritualistic ceremonies, the knowledge thereof, and the person who agrees to perform them are inspired by the Supreme Soul. As confirmed in Bhagavad-gītā, mattaḥ smṛtir jñānam apohanaṁ ca: ), and when one is advanced in Vedic knowledge, the Supersoul gives him directions. Acting as Supersoul, the Lord gives inspiration to a suitable person to perform the Vedic ritualistic ceremonies. In this connection, four classes of priests, known as ṛtvik, are required. They are mentioned as hotā, adhvaryu, brahma and udgātā."
        }
    ]
}
