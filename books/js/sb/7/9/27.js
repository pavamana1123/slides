var text = {
    ...
    "purport": [
        ...
        {
            "type": "normal",
            "content": "\"Whether one is without desire [the condition of the devotees], or is desirous of all fruitive results, or is after liberation, one should with all efforts try to worship the Supreme Personality of Godhead for complete perfection, culminating in Kṛṣṇa consciousness.\"  According to one's position, whether as a devotee, a karmī or a jñānī, whatever one wants one can get if one fully engages in the service of the Lord."
        }
    ]
}
