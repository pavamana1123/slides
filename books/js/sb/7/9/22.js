var text = {
    ...
    "purport": [
        ...
        {
            "type": "normal",
            "content": "\"Abandon all varieties of religion and just surrender unto Me. I shall deliver you from all sinful reaction. Do not fear.\" All of human society must take advantage of this offer and thus be saved by Kṛṣṇa from the danger of being crushed by the wheel of time, the wheel of past, present and future."
        },
        {
            "type": "normal",
            "content": "The word niṣpīḍyamānam (\"being crushed\") is very significant. Every living entity in the material condition is actually being crushed again and again, and to be saved from this position one must take shelter of the Supreme Personality of Godhead. Then one will be happy. The word prapannam is also very significant, for unless one fully surrenders to the Supreme Lord one cannot be saved from being crushed. A criminal is put in prison and punished by the government, but the same government, if it likes, can release the criminal from imprisoned life. Similarly, we must know conclusively that our material condition of suffering has been allotted to us by the Supreme Personality of Godhead, and if we want to be saved from this suffering, we must appeal to the same controller. Thus one can be saved from this material condition."
        }
    ]
}
