var text = {
    ...
    "purport": [
        {
            "type": "normal",
            "content": "As described in previous verses, many so-called students of spiritual understanding follow the ten different methods known as mauna-vrata-śruta-tapo-'dhyayana-sva-dharma-vyākhyā-raho japa-samādhayaḥ , the Supreme Godhead personally says, bhaktyāham ekayā grāhyaḥ: one can understand the original cause of all causes, the Supreme Person, only by devotional service, not by show-bottle exhibitionism."
        }
    ]
}
