var text = {
    "info": {
        "id": "sb/7/11/35",
        "prevId": "sb/7/11/33-34",
        "nextId": "sb/7/12/1"
    },
    "verses": [
        {
            "roman": "yasya yal lakṣaṇaṁ proktaṁ\npuṁso varṇābhivyañjakam\nyad anyatrāpi dṛśyeta\ntat tenaiva vinirdiśet\n"
        }
    ],
    "synonyms": "yasya—of whom; yat—which; lakṣaṇam—symptom; proktam—described (above); puṁsaḥ—of a person; varṇa-abhivyañjakam—indicating the classification (brāhmaṇa, kṣatriya, vaiśya, śūdra, etc.); yat—if; anyatra—elsewhere; api—also; dṛśyeta—is seen; tat—that; tena—by that symptom; eva—certainly; vinirdiśet—one should designate.",
