var text = {
    ...
    "verses": [
        {
            "roman": "yadā sisṛkṣuḥ pura ātmanaḥ paro\nrajaḥ sṛjaty eṣa pṛthak sva-māyayā\nsattvaṁ vicitrāsu riraṁsur īśvaraḥ\nśayiṣyamāṇas tama īrayaty asau\n"
        }
    ],
    "synonyms": "yadā—when; sisṛkṣuḥ—desiring to create; puraḥ—material bodies; ātmanaḥ—for the living entities; paraḥ—the Supreme Personality of Godhead; rajaḥ—the mode of passion; sṛjati—manifests; eṣaḥ—He; pṛthak—separately, predominantly; sva-māyayā—by His own creative energy; sattvam—the mode of goodness; vicitrāsu—in various types of bodies; riraṁsuḥ—desiring to act; īśvaraḥ—the Personality of Godhead; śayiṣyamāṇaḥ—being about to conclude; tamaḥ—the mode of ignorance; īrayati—causes to rise; asau—that Supreme.",
    "translation": "When the Supreme Personality of Godhead creates different types of bodies, offering a particular body to each living entity according to his character and fruitive actions, the Lord revives all the qualities of material nature—sattva-guṇa, rajo-guṇa and tamo-guṇa. Then, as the Supersoul, He enters each body and influences the qualities of creation, maintenance and annihilation, using sattva-guṇa for maintenance, rajo-guṇa for creation and tamo-guṇa for annihilation.",
    "purport": [
        {
            "type": "normal",
            "content": "Although material nature is conducted by the three qualities—sattva-guṇa, rajo-guṇa and tamo-guṇa—nature is not independent. As the Lord says in Bhagavad-gītā :"
        },
        {
            "type": "verse",
