var text = {
    ...
    "verses": [
        {
            "roman": "jyotir-ādir ivābhāti\nsaṅghātān na vivicyate\nvidanty ātmānam ātma-sthaṁ\nmathitvā kavayo 'ntataḥ\n"
        }
    ],
    "synonyms": "jyotiḥ—fire; ādiḥ—and other elements; iva—just as; ābhāti—appear; saṅghātāt—from the bodies of demigods and others; na—not; vivicyate—are distinguished; vidanti—perceive; ātmānam—the Supersoul; ātma-stham—situated in the heart; mathitvā—by discerning; kavayaḥ—expert thinkers; antataḥ—within.",
    "translation": "The all-pervading Personality of Godhead exists within the heart of every living being, and an expert thinker can perceive how He is present there to a large or small extent. Just as one can understand the supply of fire in wood, the water in a waterpot, or the sky within a pot, one can understand whether a living entity is a demon or a demigod by understanding that living entity's devotional performances. A thoughtful man can understand how much a person is favored by the Supreme Lord by seeing his actions.",
    "purport": [
        {
            "type": "normal",
        ...
        {
            "type": "verse",
            "content": "yad yad vibhūtimat sattvaṁśrīmad ūrjitam eva vā\ntat tad evāvagaccha tvaṁmama tejo-'ṁśa-sambhavam"
        },
        {
            "type": "normal",
            "content": "\"Know that all beautiful, glorious and mighty creations spring from but a spark of My splendor.\" We have the practical experience of seeing that one person is able to do very wonderful things whereas another cannot do those same things and cannot even do things that require only a little common sense. Therefore, how much a devotee has been favored by the Supreme Personality of Godhead can be tested by the activities the devotee has performed. In Bhagavad-gītā  the Lord also says:"
        },
        {
            "type": "verse",
