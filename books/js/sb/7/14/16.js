var text = {
    ...
    "verses": [
        {
            "roman": "yarhy ātmano 'dhikārādyāḥ\nsarvāḥ syur yajña-sampadaḥ\nvaitānikena vidhinā\nagni-hotrādinā yajet\n"
        }
    ],
    "synonyms": "yarhi—when; ātmanaḥ—of one's self; adhikāra-ādyāḥ—things possessed by him under full control; sarvāḥ—everything; syuḥ—becomes; yajña-sampadaḥ—paraphernalia for performing yajña, or the means for pleasing the Supreme Personality of Godhead; vaitānikena—with authorized books that direct the performance of yajña; vidhinā—according to regulative principles; agni-hotra-ādinā—by offering sacrifices to the fire, etc.; yajet—one should worship the Supreme Personality of Godhead.",
    "translation": "When one is enriched with wealth and knowledge which are under his full control and by means of which he can perform yajña or please the Supreme Personality of Godhead, one must perform sacrifices, offering oblations to the fire according to the directions of the śāstras. In this way one should worship the Supreme Personality of Godhead.",
    "purport": [
        {
            "type": "normal",
            "content": "If a gṛhastha, or householder, is sufficiently educated in Vedic knowledge and has become sufficiently rich to offer worship to please the Supreme Personality of Godhead, he must perform yajñas as directed by the authorized scriptures. Bhagavad-gītā :"
        },
        {
            "type": "verse",
