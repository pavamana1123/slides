var text = {
    ...
    "verses": [
        {
            "roman": "śithilāvayavo yarhi\ngandharvair hṛta-pauruṣaḥ\nyavanair aribhī rājann\nuparuddho ruroda ha\n"
        }
    ],
    "synonyms": "śithila—slackened; avayavaḥ—his limbs; yarhi—when; gandharvaiḥ—by the Gandharvas; hṛta—defeated; pauruṣaḥ—his bodily strength; yavanaiḥ—by the Yavanas; aribhiḥ—by the enemies; rājan—O King Prācīnabarhiṣat; uparuddhaḥ—being checked; ruroda—cried loudly; ha—indeed.",
    "translation": "The limbs of the serpent's body were slackened by the Gandharvas and Yavana soldiers, who had thoroughly defeated his bodily strength. When he attempted to leave the body, he was checked by his enemies. Being thus baffled in his attempt, he began to cry loudly.",
    "purport": [
        {
            "type": "normal",
            "content": "At the last stage of life, the different gates of the body are choked by the effects of disease, which are caused by an imbalance of bile, mucus and air. Thus the living entity cannot clearly express his difficulties, and surrounding relatives hear the sound \"ghura ghura\" from a dying man. In his Mukunda-mālā-stotra, King Kulaśekhara states:"
        },
        {
            "type": "verse",
