var text = {
    ...
    "verses": [
        {
            "roman": "vipaṇas tu kriyā-śaktir\nbhūta-prakṛtir avyayā\nśakty-adhīśaḥ pumāṁs tv atra\npraviṣṭo nāvabudhyate\n"
        }
    ],
    "synonyms": "vipaṇaḥ—stores; tu—then; kriyā-śaktiḥ—the energy for activities, or the working senses; bhūta—the five gross elements; prakṛtiḥ—the material elements; avyayā—eternal; śakti—the energy; adhīśaḥ—controller; pumān—man; tu—then; atra—here; praviṣṭaḥ—entered; na—does not; avabudhyate—become subjected to knowledge.",
    ...
    "purport": [
        ...
        {
            "type": "verse",
            "content": "prakṛtiṁ puruṣaṁ caivaviddhy anādī ubhāv api\nvikārāṁś ca guṇāṁś caivaviddhi prakṛti-sambhavān"
        },
        {
            "type": "normal",
            "content": "\"Material nature and the living entities should be understood to be beginningless. Their transformations and the modes of matter are products of material nature.\" prakṛti, material nature, and puruṣa, the living entity, are eternal. When they both come in contact, there are different reactions and manifestations. All of them should be considered the results of the interaction of the three modes of material nature."
        }
    ]
}
