var text = {
    ...
    "verses": [
        {
            "roman": "tad brahma paramaṁ śuddhaṁ\nsatāṁ vartma sanātanam\nvigarhya yāta pāṣaṇḍaṁ\ndaivaṁ vo yatra bhūta-rāṭ\n"
        }
    ],
    "synonyms": "tat—that; brahma—Veda; paramam—supreme; śuddham—pure; satām—of the saintly persons; vartma—path; sanātanam—eternal; vigarhya—blaspheming; yāta—should go; pāṣaṇḍam—to atheism; daivam—deity; vaḥ—your; yatra—where; bhūta-rāṭ—the lord of the bhūtas.",
    "translation": "By blaspheming the principles of the Vedas, which are the pure and supreme path of the saintly persons, certainly you followers of Bhūtapati, Lord Śiva, will descend to the standard of atheism without a doubt.",
    "purport": [
        {
            "type": "normal",
