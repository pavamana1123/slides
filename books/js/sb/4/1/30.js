var text = {
    ...
    "synonyms": "devāḥ ūcuḥ—the demigods replied; yathā—as; kṛtaḥ—done; te—by you; saṅkalpaḥ—determination; bhāvyam—to be done; tena eva—by that; na anyathā—not otherwise; sat-saṅkalpasya—one whose determination is never lost; te—of you; brahman—O dear brāhmaṇa; yat—that which; vai—certainly; dhyāyati—meditating; te—all of them; vayam—we are.",
    "translation": "The three deities told Atri Muni: Dear brāhmaṇa, you are perfect in your determination, and therefore as you have decided, so it will happen; it will not happen otherwise. We are all the same person upon whom you were meditating, and therefore we have all come to you.",
    "purport": [
        {
            "type": "normal",
        ...
        {
            "type": "normal",
            "content": "Viṣṇu is the Lord of the universe because He is its maintainer. Similarly, Brahmā creates the different planetary systems and the population, so he also may be considered the Lord of the universe. Or Lord Śiva, who is ultimately the destroyer of the universe, also may be considered its Lord. Therefore, since Atri Muni did not specifically mention whom he wanted, all three—Brahmā, Viṣṇu and Lord Śiva—came before him. They said, \"Since you were thinking of having a son exactly like the Supreme Personality of Godhead, the Lord of the universe, your determination will be fulfilled.\" In other words, one's determination is fulfilled according to the strength of one's devotion. As stated in Bhagavad-gītā : yānti deva-vratā devān pitṟn yānti pitṛ-vratāḥ. If one is attached to a particular demigod, one is promoted to the abode of that demigod; if one is attached to the Pitās, or forefathers, one is promoted to their planet; and similarly if one is attached to the Supreme Personality of Godhead, Kṛṣṇa, one is promoted to the abode of Lord Kṛṣṇa. Atri Muni had no clear conception of the Lord of the universe; therefore the three presiding deities who are actually the lords of the universe in the three departments of the modes of nature all came before him. Now, according to the strength of his determination for a son, his desire would be fulfilled by the grace of the Lord."
        }
    ]
}
