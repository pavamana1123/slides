var text = {
    "info": {
        "id": "sb/4/29/17",
        "prevId": "sb/4/29/16",
        "nextId": "sb/4/29/18-20"
    },
    "verses": [
        {
            "roman": "yathā yathā vikriyate\nguṇākto vikaroti vā\ntathā tathopadraṣṭātmā\ntad-vṛttīr anukāryate\n"
        }
    ],
    "synonyms": "yathā yathā—just as; vikriyate—is agitated; guṇa-aktaḥ—associated with the modes of nature; vikaroti—as it does; vā—or; tathā tathā—similarly; upadraṣṭā—observer; ātmā—the soul; tat—of the intelligence; vṛttīḥ—occupations; anukāryate—imitates.",
    ...
    "purport": [
        {
            "type": "normal",
            "content": "The queen of Purañjana is described herein as intelligence itself. Intelligence acts both in the dream state and in the waking state, but it is contaminated by the three modes of material nature. Since the intelligence is contaminated, the living entity is also contaminated. In the conditioned state, the living entity acts according to his contaminated intelligence. Although he simply remains an observer, he nonetheless acts, being forced by a contaminated intelligence, which in reality is a passive agent."
        }
    ]
}
