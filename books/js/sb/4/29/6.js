var text = {
    ...
    "verses": [
        {
            "roman": "sakhāya indriya-gaṇā\njñānaṁ karma ca yat-kṛtam\nsakhyas tad-vṛttayaḥ prāṇaḥ\npañca-vṛttir yathoragaḥ\n"
        }
    ],
    "synonyms": "sakhāyaḥ—the male friends; indriya-gaṇāḥ—the senses; jñānam—knowledge; karma—activity; ca—also; yat-kṛtam—done by the senses; sakhyaḥ—female friends; tat—of the senses; vṛttayaḥ—engagements; prāṇaḥ—life air; pañca-vṛttiḥ—having five processes; yathā—like; uragaḥ—the serpent.",
    ...
    "purport": [
        ...
        {
            "type": "verse",
            "content": "utkrāmantaṁ sthitaṁ vāpibhuñjānaṁ vā guṇānvitam\nvimūḍhā nānupaśyantipaśyanti jñāna-cakṣuṣaḥ"
        },
        {
            "type": "normal",
            "content": "\"The foolish cannot understand how a living entity can quit his body, nor can they understand what sort of body he enjoys under the spell of the modes of nature. But one whose eyes are trained in knowledge can see all this.\""
        },
        {
            "type": "normal",
