var text = {
    ...
    "purport": [
        ...
        {
            "type": "normal",
            "content": "\"When one is not attached to anything, but at the same time accepts everything in relation to Kṛṣṇa, one is rightly situated above possessiveness.\" (Bhakti-rasāmṛta-sindhu 1.2.255)"
        },
        {
            "type": "normal",
            "content": "One should not be attached to material opulence, but material opulence may be accepted in the Kṛṣṇa consciousness movement to facilitate the propagation of the movement. In other words, material opulence may be accepted as yukta-vairāgya, that is, for renunciation."
        }
    ]
}
