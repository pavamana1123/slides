var text = {
    "info": {
        "id": "sb/4/29/45",
        "prevId": "sb/4/29/42-44",
        "nextId": "sb/4/29/46"
    },
    "verses": [
        {
            "roman": "śabda-brahmaṇi duṣpāre\ncaranta uru-vistare\nmantra-liṅgair vyavacchinnaṁ\nbhajanto na viduḥ param\n"
        }
    ],
    "synonyms": "śabda-brahmaṇi—in the Vedic literature; duṣpāre—unlimited; carantaḥ—being engaged; uru—greatly; vistare—expansive; mantra—of Vedic hymns; liṅgaiḥ—by the symptoms; vyavacchinnam—partially powerful (the demigods); bhajantaḥ—worshiping; na viduḥ—they do not know; param—the Supreme.",
    "translation": "Despite the cultivation of Vedic knowledge, which is unlimited, and the worship of different demigods by the symptoms of Vedic mantras, demigod worship does not help one to understand the supreme powerful Personality of Godhead.",
    "purport": [
        {
            "type": "normal",
