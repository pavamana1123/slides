var text = {
    ...
    "verses": [
        {
            "roman": "nimitta-mātraṁ tatrāsīn\nnirguṇaḥ puruṣarṣabhaḥ\nvyaktāvyaktam idaṁ viśvaṁ\nyatra bhramati lohavat\n"
        }
    ],
    "synonyms": "nimitta-mātram—remote cause; tatra—then; āsīt—was; nirguṇaḥ—uncontaminated; puruṣa-ṛṣabhaḥ—the Supreme Person; vyakta—manifested; avyaktam—unmanifested; idam—this; viśvam—world; yatra—where; bhramati—moves; loha-vat—like iron.",
    ...
    "purport": [
        ...
        {
            "type": "normal",
            "content": "There are many causes and effects, but the original cause is Śrī Kṛṣṇa."
        }
    ]
}
