var text = {
    ...
    "verses": [
        {
            "roman": "tat tāta gaccha bhadraṁ te\nyamunāyās taṭaṁ śuci\npuṇyaṁ madhuvanaṁ yatra\nsānnidhyaṁ nityadā hareḥ\n"
        }
    ],
    "synonyms": "tat—that; tāta—my dear son; gaccha—go; bhadram—good fortune; te—for you; yamunāyāḥ—of the Yamunā; taṭam—bank; śuci—being purified; puṇyam—the holy; madhu-vanam—of the name Madhuvana; yatra—where; sānnidhyam—being nearer; nityadā—always; hareḥ—of the Supreme Personality of Godhead.",
    "translation": "My dear boy, I therefore wish all good fortune for you. You should go to the bank of the Yamunā, where there is a virtuous forest named Madhuvana, and there be purified. Just by going there, one draws nearer to the Supreme Personality of Godhead, who always lives there.",
    "purport": [
        {
            "type": "normal",
