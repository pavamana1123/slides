var text = {
    ...
    "verses": [
        {
            "roman": "svecchāvatāra-caritair\nacintya-nija-māyayā\nkariṣyaty uttamaślokas\ntad dhyāyed dhṛdayaṅ-gamam\n"
        }
    ],
    "synonyms": "sva-icchā—by His own supreme will; avatāra—incarnation; caritaiḥ—activities; acintya—inconceivable; nija-māyayā—by His own potency; kariṣyati—performs; uttama-ślokaḥ—the Supreme Personality of Godhead; tat—that; dhyāyet—one should meditate; hṛdayam-gamam—very attractive.",
    ...
    "purport": [
        ...
        {
            "type": "normal",
            "content": "Nārada advises Dhruva to meditate on the pastimes of the Lord, which is as good as the meditation of concentrating one's mind on the form of the Lord. As meditation on any form of the Lord is valuable, so is chanting of different names of the Lord, such as Hari, Govinda and Nārāyaṇa. But in this age we are especially advised to chant the Hare Kṛṣṇa mantra as enunciated in the śāstra: Hare Kṛṣṇa, Hare Kṛṣṇa, Kṛṣṇa Kṛṣṇa, Hare Hare/ Hare Rāma, Hare Rāma, Rāma Rāma, Hare Hare."
        }
    ]
}
