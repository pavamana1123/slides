var text = {
    ...
    "verses": [
        {
            "roman": "aho tejaḥ kṣatriyāṇāṁ\nmāna-bhaṅgam amṛṣyatām\nbālo 'py ayaṁ hṛdā dhatte\nyat samātur asad-vacaḥ\n"
        }
    ],
    "synonyms": "aho—how surprising it is; tejaḥ—power; kṣatriyāṇām—of the kṣatriyas; māna-bhaṅgam—hurting the prestige; amṛṣyatām—unable to tolerate; bālaḥ—only a child; api—although; ayam—this; hṛdā—at heart; dhatte—has taken; yat—that which; sa-mātuḥ—of the stepmother; asat—unpalatable; vacaḥ—words.",
    "translation": "How wonderful are the powerful kṣatriyas. They cannot tolerate even a slight infringement upon their prestige. Just imagine! This boy is only a small child, yet harsh words from his stepmother proved unbearable to him.",
    "purport": [
        {
            "type": "normal",
