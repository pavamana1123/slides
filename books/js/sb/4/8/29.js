var text = {
    ...
    "verses": [
        {
            "roman": "parituṣyet tatas tāta\ntāvan-mātreṇa pūruṣaḥ\ndaivopasāditaṁ yāvad\nvīkṣyeśvara-gatiṁ budhaḥ\n"
        }
    ],
    "synonyms": "parituṣyet—one should be satisfied; tataḥ—therefore; tāta—my dear boy; tāvat—up to such; mātreṇa—quality; pūruṣaḥ—a person; daiva—destiny; upasāditam—offered by; yāvat—as; vīkṣya—seeing; īśvara-gatim—the process of the Supreme; budhaḥ—one who is intelligent.",
    "translation": "The process of the Supreme Personality of Godhead is very wonderful. One who is intelligent should accept that process and be satisfied with whatever comes, favorable or unfavorable, by His supreme will.",
    "purport": [
        {
            "type": "normal",
