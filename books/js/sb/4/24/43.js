var text = {
    ...
    "verses": [
        {
            "roman": "śakti-traya-sametāya\nmīḍhuṣe 'haṅkṛtātmane\nceta-ākūti-rūpāya\nnamo vāco vibhūtaye\n"
        }
    ],
    "synonyms": "śakti-traya—three kinds of energies; sametāya—unto the reservoir; mīḍhuṣe—unto Rudra; ahaṅkṛta-ātmane—the source of egotism; cetaḥ—knowledge; ākūti—eagerness to work; rūpāya—unto the form of; namaḥ—my obeisances; vācaḥ—unto the sound; vibhūtaye—unto the different types of opulences.",
