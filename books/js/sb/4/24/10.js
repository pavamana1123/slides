var text = {
    ...
    "verses": [
        {
            "roman": "yasyedaṁ deva-yajanam\nanuyajñaṁ vitanvataḥ\nprācīnāgraiḥ kuśair āsīd\nāstṛtaṁ vasudhā-talam\n"
        }
    ],
    "synonyms": "yasya—whose; idam—this; deva-yajanam—satisfying the demigods by sacrifices; anuyajñam—continually sacrificing; vitanvataḥ—executing; prācīna-agraiḥ—keeping the kuśa grass facing toward the eastern side; kuśaiḥ—the kuśa grass; āsīt—remained; āstṛtam—scattered; vasudhā-talam—all over the surface of the globe.",
    "translation": "Mahārāja Barhiṣat executed many sacrifices all over the world. He scattered kuśa grasses and kept the tops of the grasses pointed eastward.",
    "purport": [
        {
            "type": "normal",
