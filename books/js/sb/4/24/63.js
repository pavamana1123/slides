var text = {
    ...
    "verses": [
        {
            "roman": "tvam eka ādyaḥ puruṣaḥ supta-śaktis\ntayā rajaḥ-sattva-tamo vibhidyate\nmahān ahaṁ khaṁ marud agni-vār-dharāḥ\nsurarṣayo bhūta-gaṇā idaṁ yataḥ\n"
        }
    ],
    "synonyms": "tvam—Your Lordship; ekaḥ—one; ādyaḥ—the original; puruṣaḥ—person; supta—dormant; śaktiḥ—energy; tayā—by which; rajaḥ—the passion energy; sattva—goodness; tamaḥ—ignorance; vibhidyate—is diversified; mahān—the total material energy; aham—egotism; kham—the sky; marut—the air; agni—fire; vāḥ—water; dharāḥ—earth; sura-ṛṣayaḥ—the demigods and the great sages; bhūta-gaṇāḥ—the living entities; idam—all this; yataḥ—from whom.",
    ...
    "purport": [
        ...
        {
            "type": "normal",
            "content": "Those who are covered by the material energy cannot understand that the origin of everything is the Supreme Personality of Godhead, Kṛṣṇa. This is summarized in the Vedānta aphorism janmādy asya yataḥ :"
        },
        {
            "type": "verse",
