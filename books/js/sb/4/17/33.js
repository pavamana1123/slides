var text = {
    ...
    "purport": [
        {
            "type": "normal",
            "content": "All activities begin with the creation of the total energy, the mahat-tattva. Then, by the agitation of the three guṇas, the physical elements are created, as well as the mind, ego and the controllers of the senses. All of these are created one after another by the inconceivable energy of the Lord. In modern electronics, a mechanic may, by pushing only one button, set off an electronic chain-reaction, by which so many actions are carried out one after another. Similarly, the Supreme Personality of Godhead pushes the button of creation, and different energies create the material elements and various controllers of the physical elements, and their subsequent interactions follow the inconceivable plan of the Supreme Personality of Godhead."
        }
    ]
}
