var text = {
    ...
    "verses": [
        {
            "roman": "ekaḥ śuddhaḥ svayaṁ-jyotir\nnirguṇo 'sau guṇāśrayaḥ\nsarva-go 'nāvṛtaḥ sākṣī\nnirātmātmātmanaḥ paraḥ\n"
        }
    ],
    "synonyms": "ekaḥ—one; śuddhaḥ—pure; svayam—self; jyotiḥ—effulgent; nirguṇaḥ—without material qualifications; asau—that; guṇa-āśrayaḥ—the reservoir of good qualities; sarva-gaḥ—able to go everywhere; anāvṛtaḥ—without being covered by matter; sākṣī—witness; nirātmā—without another self; ātma-ātmanaḥ—to the body and mind; paraḥ—transcendental.",
    "translation": "The individual soul is one, Pure, nonmaterial and self-effulgent. He is the reservoir of all good qualities, and He is all-pervading. He is without material covering, and He is the witness of all activities. He is completely distinguished from other living entities, and He is transcendental to all embodied souls.",
    "purport": [
        {
            "type": "normal",
