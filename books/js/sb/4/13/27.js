var text = {
    ...
    "verses": [
        {
            "roman": "rājan havīṁṣy aduṣṭāni\nśraddhayāsāditāni te\nchandāṁsy ayāta-yāmāni\nyojitāni dhṛta-vrataiḥ\n"
        }
    ],
    "synonyms": "rājan—O King; havīṁṣi—sacrificial offerings; aduṣṭāni—not polluted; śraddhayā—with great faith and care; āsāditāni—collected; te—your; chandāṁsi—the mantras; ayāta-yāmāni—not deficient; yojitāni—properly executed; dhṛta-vrataiḥ—by qualified brāhmaṇas.",
    "translation": "O King, we know that the paraphernalia to perform the sacrifice is well collected by you with great faith and care and is not polluted. Our chanting of the Vedic hymns is also not deficient in any way, for all the brāhmaṇas and priests present here are expert and are executing the performances properly.",
    "purport": [
        {
            "type": "normal",
