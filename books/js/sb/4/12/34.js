var text = {
    ...
    "verses": [
        {
            "roman": "tatra tatra praśaṁsadbhiḥ\npathi vaimānikaiḥ suraiḥ\navakīryamāṇo dadṛśe\nkusumaiḥ kramaśo grahān\n"
        }
    ],
    "synonyms": "tatra tatra—here and there; praśaṁsadbhiḥ—by persons engaged in the praise of Dhruva Mahārāja; pathi—on the path; vaimānikaiḥ—carried by different types of airplanes; suraiḥ—by the demigods; avakīryamāṇaḥ—being covered; dadṛśe—could see; kusumaiḥ—by flowers; kramaśaḥ—one after another; grahān—all the planets of the solar system.",
    "translation": "While Dhruva Mahārāja was passing through space, he gradually saw all the planets of the solar system, and on the path he saw all the demigods in their airplanes showering flowers upon him like rain.",
    "purport": [
        {
            "type": "normal",
