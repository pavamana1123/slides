var text = {
    ...
    "verses": [
        {
            "roman": "parītyābhyarcya dhiṣṇyāgryaṁ\npārṣadāv abhivandya ca\niyeṣa tad adhiṣṭhātuṁ\nbibhrad rūpaṁ hiraṇmayam\n"
        }
    ],
    "synonyms": "parītya—having circumambulated; abhyarcya—having worshiped; dhiṣṇya-agryam—the transcendental airplane; pārṣadau—unto the two associates; abhivandya—having offered obeisances; ca—also; iyeṣa—he attempted; tat—that plane; adhiṣṭhātum—to board; bibhrat—illuminating; rūpam—his form; hiraṇmayam—golden.",
    "translation": "Before getting aboard, Dhruva Mahārāja worshiped the airplane, circumambulated it, and also offered obeisances to the associates of Viṣṇu. In the meantime he became as brilliant and illuminating as molten gold. He was thus completely prepared to board the transcendental plane.",
    "purport": [
        {
            "type": "normal",
