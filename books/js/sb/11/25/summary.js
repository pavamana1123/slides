var text = {
    ...
    "purport": [
        {
            "type": "normal",
            "content": "To establish the transcendental nature of the Supreme Personality of Godhead, this chapter describes the various functional manifestations of the three modes (goodness, passion and ignorance), which arise in the mind."
        },
        {
            "type": "normal",
            "content": "Control of the mind, control of the senses, tolerance and so forth are manifestations of the unmixed mode of goodness. Desire, endeavor, false pride and so on are manifestations of the unmixed mode of passion. And anger, greed and bewilderment are among the functions of the unmixed mode of ignorance. In the admixture of the three modes we find the concept of \"I\" and \"my,\" behavior in accordance with this mentality by body, mind and words, adherence to the principles of religiosity, economic development and sense gratification, and the fixed pursuit of one's occupational duty for material interest."
        },
        {
            "type": "normal",
