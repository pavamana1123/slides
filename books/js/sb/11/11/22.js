var text = {
    ...
    "verses": [
        {
            "roman": "yady anīśo dhārayituṁ\nmano brahmaṇi niścalam\nmayi sarvāṇi karmāṇi\nnirapekṣaḥ samācara\n"
        }
    ],
    "synonyms": "yadi—if; anīśaḥ—incapable; dhārayitum—to fix; manaḥ—the mind; brahmaṇi—on the spiritual platform; niścalam—free from sense gratification; mayi—in Me; sarvāṇi—all; karmāṇi—activities; nirapekṣaḥ—without trying to enjoy the fruits; samācara—execute.",
    ...
    "purport": [
        {
            "type": "normal",
            "content": "If one offers one's activities to Lord Kṛṣṇa without trying to enjoy the results, one's mind becomes purified. When the mind is purified, transcendental knowledge automatically manifests, since such knowledge is a by-product of pure consciousness. When the mind is absorbed in perfect knowledge, it can be raised to the spiritual platform, as described in Bhagavad-gītā :"
        },
        {
            "type": "verse",
            "content": "brahma-bhūtaḥ prasannātmāna śocati na kānkṣati\nsamaḥ sarveṣu bhūteṣumad-bhaktiṁ labhate parām"
        },
        {
            "type": "normal",
