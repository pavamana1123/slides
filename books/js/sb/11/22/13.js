var text = {
    ...
    "verses": [
        {
            "roman": "sattvaṁ jñānaṁ rajaḥ karma\ntamo 'jñānam ihocyate\nguṇa-vyatikaraḥ kālaḥ\nsvabhāvaḥ sūtram eva ca\n"
        }
    ],
    "synonyms": "sattvam—the mode of goodness; jñānam—knowledge; rajaḥ—the mode of passion; karma—fruitive work; tamaḥ—the mode of ignorance; ajñānam—foolishness; iha—in this world; ucyate—is called; guṇa—of the modes; vyatikaraḥ—the agitated transformation; kālaḥ—time; svabhāvaḥ—innate tendency, nature; sūtram—the mahat-tattva; eva—indeed; ca—also.",
    "translation": "In this world the mode of goodness is recognized as knowledge, the mode of passion as fruitive work, and the mode of darkness as ignorance. Time is perceived as the agitated interaction of the material modes, and the totality of functional propensity is embodied by the primeval sūtra, or mahat-tattva.",
    "purport": [
        {
            "type": "normal",
