var text = {
    ...
    "verses": [
        {
            "roman": "viṣayābhiniveśena\nnātmānaṁ yat smaret punaḥ\njantor vai kasyacid dhetor\nmṛtyur atyanta-vismṛtiḥ\n"
        }
    ],
    "synonyms": "viṣaya—in (new) objects of perception; abhiniveśena—because of absorption; na—not; ātmānam—his previous self; yat—the situation in which; smaret—remembers; punaḥ—any more; jantoḥ—of the living entity; vai—indeed; kasyacit hetoḥ—for any reason or other; mṛtyuḥ—known as death; atyanta—total; vismṛtiḥ—forgetfulness.",
