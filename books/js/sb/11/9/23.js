var text = {
    ...
    "verses": [
        {
            "roman": "kīṭaḥ peśaskṛtaṁ dhyāyan\nkuḍyāṁ tena praveśitaḥ\nyāti tat-sātmatāṁ rājan\npūrva-rūpam asantyajan\n"
        }
    ],
    "synonyms": "kīṭaḥ—an insect; peśaskṛtam—a wasp; dhyāyan—meditating on; kuḍyām—in his hive; tena—by the wasp; praveśitaḥ—forced to enter; yāti—he goes; tat—of the wasp; sa-ātmatām—the same state of existence; rājan—O King; pūrva-rūpam—the previous body; asantyajan—not giving up.",
