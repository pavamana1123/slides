var text = {
    ...
    "verses": [
        {
            "roman": "manasā vacasā dṛṣṭyā\ngṛhyate 'nyair apīndriyaiḥ\naham eva na matto 'nyad\niti budhyadhvam añjasā\n"
        }
    ],
    "synonyms": "manasā—by the mind; vacasā—by speech; dṛṣṭyā—by sight; gṛhyate—is perceived and thus accepted; anyaiḥ—by others; api—even; indriyaiḥ—senses; aham—I; eva—indeed; na—not; mattaḥ—besides Me; anyat—anything else; iti—thus; budhyadhvam—you should all understand; añjasā—by straightforward analysis of the facts.",
