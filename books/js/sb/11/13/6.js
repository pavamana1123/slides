var text = {
    ...
    "verses": [
        {
            "roman": "sāttvikāny eva seveta\npumān sattva-vivṛddhaye\ntato dharmas tato jñānaṁ\nyāvat smṛtir apohanam\n"
        }
    ],
    "synonyms": "sāttvikāni—things in the mode of goodness; eva—indeed; seveta—he should cultivate; pumān—a person; sattva—the mode of goodness; vivṛddhaye—in order to increase; tataḥ—from that (increase in goodness); dharmaḥ—one is fixed in religious principles; tataḥ—from that (religion); jñānam—knowledge is manifest; yāvat—until; smṛtiḥ—self-realization, remembering one's eternal identity; apohanam—driving away (the illusory identification with the material body and mind).",
