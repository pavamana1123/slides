var text = {
    ...
    "verses": [
        {
            "roman": "sāyaṁ prātar upānīya\nbhaikṣyaṁ tasmai nivedayet\nyac cānyad apy anujñātam\nupayuñjīta saṁyataḥ\n"
        }
    ],
    "synonyms": "sāyam—in the evening; prātaḥ—in the morning; upānīya—bringing; bhaikṣyam—food that is collected by begging; tasmai—unto him (the ācārya); nivedayet—one should deliver; yat—that which; ca—also; anyat—other things; api—indeed; anujñātam—that which is permitted; upayuñjīta—one should accept; saṁyataḥ—being fully controlled.",
    "translation": "In the morning and evening one should collect foodstuffs and other articles and deliver them to the spiritual master. Then, being self-controlled, one should accept for oneself that which is allotted by the ācārya.",
    "purport": [
        {
            "type": "normal",
