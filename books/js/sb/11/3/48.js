var text = {
    ...
    "verses": [
        {
            "roman": "labdhvānugraha ācāryāt\ntena sandarśitāgamaḥ\nmahā-puruṣam abhyarcen\nmūrtyābhimatayātmanaḥ\n"
        }
    ],
    "synonyms": "labdhvā—having obtained; anugrahaḥ—mercy; ācāryāt—from the spiritual master; tena—by him; sandarśita—being shown; āgamaḥ—(the process of worship given by) the vaiṣṇava-tantras; mahā-puruṣam—the Supreme Person; abhyarcet—the disciple should worship; mūrtyā—in the particular personal form; abhimatayā—which is preferred; ātmanaḥ—by himself.",
    "translation": "Having obtained the mercy of his spiritual master, who reveals to the disciple the injunctions of Vedic scriptures, the devotee should worship the Supreme Personality of Godhead in the particular personal form of the Lord the devotee finds most attractive.",
    "purport": [
        {
            "type": "normal",
            "content": "According to Śrīla Jīva Gosvāmī, the word labdhvānugrahaḥ indicates formal initiation by a bona fide spiritual master. It is stated in the Padma Purāṇa,"
        },
        {
            "type": "verse",
