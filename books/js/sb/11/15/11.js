var text = {
    ...
    "verses": [
        {
            "roman": "mahat-tattvātmani mayi\nyathā-saṁsthaṁ mano dadhat\nmahimānam avāpnoti\nbhūtānāṁ ca pṛthak pṛthak\n"
        }
    ],
    "synonyms": "mahat-tattva—of the total material energy; ātmani—in the Soul; mayi—in Me; yathā—according to; saṁstham—the particular situation; manaḥ—the mind; dadhat—fixing; mahimānam—the mystic perfection called mahimā; avāpnoti—one achieves; bhūtānām—of the material elements; ca—also; pṛthak pṛthak—each one individually.",
    "translation": "One who absorbs his mind in the particular form of the mahat-tattva and thus meditates upon Me as the Supreme Soul of the total material existence achieves the mystic perfection called mahimā. By further absorbing the mind in the situation of each individual element such as the sky, air, fire, and so on, one progressively acquires the greatness of each material element.",
    "purport": [
        {
            "type": "normal",
