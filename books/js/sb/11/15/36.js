var text = {
    ...
    "verses": [
        {
            "roman": "aham ātmāntaro bāhyo\n'nāvṛtaḥ sarva-dehinām\nyathā bhūtāni bhūteṣu\nbahir antaḥ svayaṁ tathā\n"
        }
    ],
    "synonyms": "aham—I; ātmā—the Supreme Lord; āntaraḥ—existing within as the Supersoul; bāhyaḥ—existing externally in My all-pervading feature; anāvṛtaḥ—uncovered; sarva-dehinām—of all living entities; yathā—just as; bhūtāni—the material elements; bhūteṣu—among living entities; bahiḥ—externally; antaḥ—internally; svayam—Myself; tathā—in the same way.",
    "translation": "Just as the same material elements exist within and outside of all material bodies, similarly, I cannot be covered by anything else. I exist within everything as the Supersoul and outside of everything in My all-pervading feature.",
    "purport": [
        {
            "type": "normal",
