var text = {
    ...
    "verses": [
        {
            "roman": "haṁsaḥ suparṇo vaikuṇṭho\ndharmo yogeśvaro 'malaḥ\nīśvaraḥ puruṣo 'vyaktaḥ\nparamātmeti gīyate\n"
        }
    ],
    "synonyms": "haṁsaḥ—the transcendental swan; su-parṇaḥ—whose wings are very beautiful; vaikuṇṭhaḥ—the Lord of the spiritual kingdom; dharmaḥ—the maintainer of religion; yoga-īśvaraḥ—the master of all mystic perfection; amalaḥ—immaculate; īśvaraḥ—the supreme controller; puruṣaḥ—the supreme enjoying male; avyaktaḥ—the unmanifest; parama-ātmā—the Supersoul in the heart of every living being; iti—thus; gīyate—His names are variously chanted.",
    "translation": "In Satya-yuga the Lord is glorified by the names Haṁsa, Suparṇa, Vaikuṇṭha, Dharma, Yogeśvara, Amala, Īśvara, Puruṣa, Avyakta and Paramātmā.",
    "purport": [
        {
            "type": "normal",
