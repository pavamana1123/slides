var text = {
    ...
    "verses": [
        {
            "roman": "yady asaṁhṛtya dṛptānāṁ\nyadūnāṁ vipulaṁ kulam\ngantāsmy anena loko 'yam\nudvelena vinaṅkṣyati\n"
        }
    ],
    "synonyms": "yadi—if; asaṁhṛtya—without withdrawing; dṛptānām—of the overly proud; yadūnām—Yadus; vipulam—the vast; kulam—dynasty; gantā asmi—I go; anena—for that reason; lokaḥ—the world; ayam—this; udvelena—by the overflow (of the Yadus); vinaṅkṣyati—will be destroyed.",
