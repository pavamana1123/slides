var text = {
    ...
    "verses": [
        {
            "roman": "nivṛttaṁ karma seveta\npravṛttaṁ mat-paras tyajet\njijñāsāyāṁ sampravṛtto\nnādriyet karma-codanām\n"
        }
    ],
    "synonyms": "nivṛttam—regulative duties; karma—such work; seveta—one should perform; pravṛttam—activities for sense gratification; mat-paraḥ—one who is dedicated to Me; tyajet—should give up; jijñāsāyām—in searching for spiritual truth; sampravṛttaḥ—being perfectly engaged; na—not; ādriyet—one should accept; karma—any material activity; codanām—injunctions governing.",
    "translation": "One who has fixed Me within his mind as the goal of life should give up activities based on sense gratification and should instead execute work governed by the regulative principles for advancement. When, however, one is fully engaged in searching out the ultimate truth of the soul, one should not accept the scriptural injunctions governing fruitive activities.",
    "purport": [
        {
            "type": "normal",
            "content": "Śrīla Viśvanātha Cakravartī Ṭhākura explains that the words jijñāsāyāṁ sampravṛttaḥ refer to one who is yoga-ārūḍha, or advanced in the yoga process. In Bhagavad-gītā  it is stated:"
        },
        {
            "type": "verse",
