var text = {
    ...
    "verses": [
        {
            "roman": "phala-śrutir iyaṁ nṟṇāṁ\nna śreyo rocanaṁ param\nśreyo-vivakṣayā proktaṁ\nyathā bhaiṣajya-rocanam\n"
        }
    ],
    "synonyms": "phala-śrutiḥ—the statements of scripture promising rewards; iyam—these; nṟṇām—for men; na—are not; śreyaḥ—the highest good; rocanam—enticement; param—merely; śreyaḥ—the ultimate good; vivakṣayā—with the idea of saying; proktam—spoken; yathā—just as; bhaiṣajya—for taking medicine; rocanam—inducement.",
    "translation": "Those statements of scripture promising fruitive rewards do not prescribe the ultimate good for men but are merely enticements for executing beneficial religious duties, like promises of candy spoken to induce a child to take beneficial medicine.",
    "purport": [
        {
            "type": "normal",
