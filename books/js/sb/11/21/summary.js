var text = {
    ...
    "purport": [
        ...
        {
            "type": "normal",
            "content": "The doctrine of varṇāśrama codifies precepts of bodily purity and impurity. With respect to place, purity and impurity are distinguished by such facts as the presence of black deer. In connection with time, there are distinctions of purity and impurity either in terms of the time itself or in terms of its specific relation with various objects. In connection with physical substances, distinctions of purity and impurity are made in terms of sanctification of objects and words and by such activities as bathing, giving charity, performing austere penances and remembering the Supreme Lord. There are also distinctions of the purity and impurity of the performers of actions. When one's knowledge of mantras is received from the lips of the bona fide spiritual master, one's mantra is considered pure, and one's work is purified by offering it unto the Supreme Personality of Godhead. If the six factors of place, time and so forth are purified, then there is dharma, or virtue, but otherwise there is adharma, or fault."
        },
        {
            "type": "normal",
