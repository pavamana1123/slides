var text = {
    ...
    "verses": [
        {
            "roman": "śabda-brahma su-durbodhaṁ\nprāṇendriya-mano-mayam\nananta-pāraṁ gambhīraṁ\ndurvigāhyaṁ samudra-vat\n"
        }
    ],
    "synonyms": "śabda-brahma—the transcendental sound of the Vedas; su-durbodham—extremely difficult to comprehend; prāṇa—of the vital air; indriya—senses; manaḥ—and mind; mayam—manifesting on the different levels; ananta-pāram—without limit; gambhīram—deep; durvigāhyam—unfathomable; samudra-vat—like the ocean.",
